...
module AACT
  class Application < Rails::Application
    ...
    AACT_BACK_DATABASE_URL       = "postgres://#{AACT_DB_SUPER_USERNAME}:#{AACT_PASS}@#{APPLICATION_HOST}:#{AACT_PORT}/#{AACT_BACK_DATABASE_NAME}"
    AACT_ADMIN_DATABASE_URL      = "postgres://#{AACT_DB_SUPER_USERNAME}:#{AACT_PASS}@#{APPLICATION_HOST}:5432/#{AACT_ADMIN_DATABASE_NAME}"
