...
module AACT
  class Application < Rails::Application
    ...
    if Rails.env != 'test'
      ...
      AACT_BACK_DATABASE_NAME   =  ENV[AACT_BACK_DATABSE_NAME] || 'aact'    # Name of background database used to process loads
      AACT_ADMIN_DATABASE_NAME  =  ENV[AACT_ADMIN_DATABSE_NAME] || 'aact_admin' # Name of database used to support the AACT website
      AACT_PUBLIC_DATABASE_NAME =  ENV[AACT_PUBLIC_DATABSE_NAME] || 'aact'  # Name of database available to the public
      AACT_ALT_PUBLIC_DATABASE_NAME = ENV[AACT_ALT_PUBLIC_DATABSE_NAME] || 'aact_alt' # Name of alternate database available to the public
    else
