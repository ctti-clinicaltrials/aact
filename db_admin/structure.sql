...
--
-- Name: schema_migrations; Type: TABLE; Schema: support; Owner: -
--

CREATE TABLE support.schema_migrations (
    version character varying NOT NULL
);
...
--
-- Name: index_sanity_checks_on_created_at; Type: INDEX; Schema: support; Owner: -
--

CREATE INDEX index_sanity_checks_on_created_at ON support.sanity_checks USING btree (created_at);


--
-- Name: index_sanity_checks_on_most_current; Type: INDEX; Schema: support; Owner: -
--

CREATE INDEX index_sanity_checks_on_most_current ON support.sanity_checks USING btree (most_current);


--
-- Name: index_sanity_checks_on_table_name; Type: INDEX; Schema: support; Owner: -
--

CREATE INDEX index_sanity_checks_on_table_name ON support.sanity_checks USING btree (table_name);


--
-- Name: index_study_xml_records_on_created_study_at; Type: INDEX; Schema: support; Owner: -
--

CREATE INDEX index_study_xml_records_on_created_study_at ON support.study_xml_records USING btree (created_study_at);


--
-- Name: index_study_xml_records_on_nct_id; Type: INDEX; Schema: support; Owner: -
--

CREATE INDEX index_study_xml_records_on_nct_id ON support.study_xml_records USING btree (nct_id);


--
-- Name: unique_schema_migrations; Type: INDEX; Schema: support; Owner: -
--

CREATE UNIQUE INDEX unique_schema_migrations ON support.schema_migrations USING btree (version);
