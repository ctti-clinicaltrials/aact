...
--
-- Name: study_json_records; Type: TABLE; Schema: ctgov_beta; Owner: -
--

CREATE TABLE ctgov_beta.study_json_records (
    id integer NOT NULL,
    nct_id character varying NOT NULL,
    content jsonb NOT NULL,
    saved_study_at timestamp without time zone,
...
--
-- Name: study_json_records_id_seq; Type: SEQUENCE; Schema: ctgov_beta; Owner: -
--

CREATE SEQUENCE ctgov_beta.study_json_records_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
--
-- Name: study_json_records_id_seq; Type: SEQUENCE OWNED BY; Schema: ctgov_beta; Owner: -
--

ALTER SEQUENCE ctgov_beta.study_json_records_id_seq OWNED BY ctgov_beta.study_json_records.id;
...
--
-- Name: study_json_records id; Type: DEFAULT; Schema: ctgov_beta; Owner: -
--

ALTER TABLE ONLY ctgov_beta.study_json_records ALTER COLUMN id SET DEFAULT nextval('ctgov_beta.study_json_records_id_seq'::regclass);
...
--
-- Name: study_json_records study_json_records_pkey; Type: CONSTRAINT; Schema: ctgov_beta; Owner: -
--

ALTER TABLE ONLY ctgov_beta.study_json_records
    ADD CONSTRAINT study_json_records_pkey PRIMARY KEY (id);
