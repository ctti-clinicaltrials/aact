...
CREATE FUNCTION ctgov_beta.count_estimate(query text) RETURNS integer
    LANGUAGE plpgsql
    AS $$
      DECLARE
        rec   record;
...
--
-- Name: ids_for_org(character varying); Type: FUNCTION; Schema: ctgov_beta; Owner: -
--

CREATE FUNCTION ctgov_beta.ids_for_org(character varying) RETURNS TABLE(nct_id character varying)
    LANGUAGE sql
    AS $_$
      SELECT DISTINCT nct_id FROM responsible_parties WHERE lower(affiliation) like lower($1)
      UNION
...
--
-- Name: ids_for_term(character varying); Type: FUNCTION; Schema: ctgov_beta; Owner: -
--

CREATE FUNCTION ctgov_beta.ids_for_term(character varying) RETURNS TABLE(nct_id character varying)
    LANGUAGE sql
    AS $_$
...
--
-- Name: study_summaries_for_condition(character varying); Type: FUNCTION; Schema: ctgov_beta; Owner: -
--

CREATE FUNCTION ctgov_beta.study_summaries_for_condition(character varying) RETURNS TABLE(nct_id character varying, title text, recruitment character varying, were_results_reported boolean, conditions text, interventions text, gender character varying, age text, phase character varying, enrollment integer, study_type character varying, sponsors text, other_ids text, study_first_submitted_date date, start_date date, completion_month_year character varying, last_update_submitted_date date, verification_month_year character varying, results_first_submitted_date date, acronym character varying, primary_completion_month_year character varying, outcome_measures text, disposition_first_submitted_date date, allocation character varying, intervention_model character varying, observational_model character varying, primary_purpose character varying, time_perspective character varying, masking character varying, masking_description text, intervention_model_description text, subject_masked boolean, caregiver_masked boolean, investigator_masked boolean, outcomes_assessor_masked boolean, number_of_facilities integer)
    LANGUAGE sql
    AS $_$
...
--
-- Name: browse_conditions; Type: TABLE; Schema: ctgov_beta; Owner: -
--

CREATE TABLE ctgov_beta.browse_conditions (
    id integer NOT NULL,
    nct_id character varying,
    mesh_term character varying,
    downcase_mesh_term character varying
...
--
-- Name: all_browse_conditions; Type: VIEW; Schema: ctgov_beta; Owner: -
--

CREATE VIEW ctgov_beta.all_browse_conditions AS
 SELECT browse_conditions.nct_id,
    array_to_string(array_agg(DISTINCT browse_conditions.mesh_term), '|'::text) AS names
   FROM ctgov_beta.browse_conditions
  GROUP BY browse_conditions.nct_id;


--
-- Name: browse_interventions; Type: TABLE; Schema: ctgov_beta; Owner: -
--

CREATE TABLE ctgov_beta.browse_interventions (
    id integer NOT NULL,
    nct_id character varying,
    mesh_term character varying,
    downcase_mesh_term character varying
...
--
-- Name: all_browse_interventions; Type: VIEW; Schema: ctgov_beta; Owner: -
--

CREATE VIEW ctgov_beta.all_browse_interventions AS
 SELECT browse_interventions.nct_id,
    array_to_string(array_agg(browse_interventions.mesh_term), '|'::text) AS names
   FROM ctgov_beta.browse_interventions
  GROUP BY browse_interventions.nct_id;


--
-- Name: facilities; Type: TABLE; Schema: ctgov_beta; Owner: -
--

CREATE TABLE ctgov_beta.facilities (
    id integer NOT NULL,
    nct_id character varying,
    status character varying,
    name character varying,
...
--
-- Name: all_cities; Type: VIEW; Schema: ctgov_beta; Owner: -
--

CREATE VIEW ctgov_beta.all_cities AS
 SELECT facilities.nct_id,
    array_to_string(array_agg(DISTINCT facilities.city), '|'::text) AS names
   FROM ctgov_beta.facilities
  GROUP BY facilities.nct_id;


--
-- Name: conditions; Type: TABLE; Schema: ctgov_beta; Owner: -
--

CREATE TABLE ctgov_beta.conditions (
    id integer NOT NULL,
    nct_id character varying,
    name character varying,
    downcase_name character varying
...
--
-- Name: all_conditions; Type: VIEW; Schema: ctgov_beta; Owner: -
--

CREATE VIEW ctgov_beta.all_conditions AS
 SELECT conditions.nct_id,
    array_to_string(array_agg(DISTINCT conditions.name), '|'::text) AS names
   FROM ctgov_beta.conditions
  GROUP BY conditions.nct_id;


--
-- Name: countries; Type: TABLE; Schema: ctgov_beta; Owner: -
--

CREATE TABLE ctgov_beta.countries (
    id integer NOT NULL,
    nct_id character varying,
    name character varying,
    removed boolean
...
--
-- Name: all_countries; Type: VIEW; Schema: ctgov_beta; Owner: -
--

CREATE VIEW ctgov_beta.all_countries AS
 SELECT countries.nct_id,
    array_to_string(array_agg(DISTINCT countries.name), '|'::text) AS names
   FROM ctgov_beta.countries
  WHERE (countries.removed IS NOT TRUE)
  GROUP BY countries.nct_id;


--
-- Name: design_outcomes; Type: TABLE; Schema: ctgov_beta; Owner: -
--

CREATE TABLE ctgov_beta.design_outcomes (
    id integer NOT NULL,
    nct_id character varying,
    outcome_type character varying,
    measure text,
...
--
-- Name: all_design_outcomes; Type: VIEW; Schema: ctgov_beta; Owner: -
--

CREATE VIEW ctgov_beta.all_design_outcomes AS
 SELECT design_outcomes.nct_id,
    array_to_string(array_agg(DISTINCT design_outcomes.measure), '|'::text) AS names
   FROM ctgov_beta.design_outcomes
  GROUP BY design_outcomes.nct_id;


--
-- Name: all_facilities; Type: VIEW; Schema: ctgov_beta; Owner: -
--

CREATE VIEW ctgov_beta.all_facilities AS
 SELECT facilities.nct_id,
...
--
-- Name: design_groups; Type: TABLE; Schema: ctgov_beta; Owner: -
--

CREATE TABLE ctgov_beta.design_groups (
    id integer NOT NULL,
    nct_id character varying,
    group_type character varying,
    title character varying,
...
--
-- Name: all_group_types; Type: VIEW; Schema: ctgov_beta; Owner: -
--

CREATE VIEW ctgov_beta.all_group_types AS
 SELECT design_groups.nct_id,
    array_to_string(array_agg(DISTINCT design_groups.group_type), '|'::text) AS names
   FROM ctgov_beta.design_groups
  GROUP BY design_groups.nct_id;


--
-- Name: id_information; Type: TABLE; Schema: ctgov_beta; Owner: -
--

CREATE TABLE ctgov_beta.id_information (
    id integer NOT NULL,
    nct_id character varying,
    id_type character varying,
    id_value character varying
...
--
-- Name: all_id_information; Type: VIEW; Schema: ctgov_beta; Owner: -
--

CREATE VIEW ctgov_beta.all_id_information AS
 SELECT id_information.nct_id,
    array_to_string(array_agg(DISTINCT id_information.id_value), '|'::text) AS names
   FROM ctgov_beta.id_information
  GROUP BY id_information.nct_id;


--
-- Name: interventions; Type: TABLE; Schema: ctgov_beta; Owner: -
--

CREATE TABLE ctgov_beta.interventions (
    id integer NOT NULL,
    nct_id character varying,
    intervention_type character varying,
    name character varying,
...
--
-- Name: all_intervention_types; Type: VIEW; Schema: ctgov_beta; Owner: -
--

CREATE VIEW ctgov_beta.all_intervention_types AS
 SELECT interventions.nct_id,
    array_to_string(array_agg(interventions.intervention_type), '|'::text) AS names
   FROM ctgov_beta.interventions
  GROUP BY interventions.nct_id;


--
-- Name: all_interventions; Type: VIEW; Schema: ctgov_beta; Owner: -
--

CREATE VIEW ctgov_beta.all_interventions AS
 SELECT interventions.nct_id,
...
--
-- Name: keywords; Type: TABLE; Schema: ctgov_beta; Owner: -
--

CREATE TABLE ctgov_beta.keywords (
    id integer NOT NULL,
    nct_id character varying,
    name character varying,
    downcase_name character varying
...
--
-- Name: all_keywords; Type: VIEW; Schema: ctgov_beta; Owner: -
--

CREATE VIEW ctgov_beta.all_keywords AS
 SELECT keywords.nct_id,
    array_to_string(array_agg(DISTINCT keywords.name), '|'::text) AS names
   FROM ctgov_beta.keywords
  GROUP BY keywords.nct_id;


--
-- Name: overall_officials; Type: TABLE; Schema: ctgov_beta; Owner: -
--

CREATE TABLE ctgov_beta.overall_officials (
    id integer NOT NULL,
    nct_id character varying,
    role character varying,
    name character varying,
...
--
-- Name: all_overall_official_affiliations; Type: VIEW; Schema: ctgov_beta; Owner: -
--

CREATE VIEW ctgov_beta.all_overall_official_affiliations AS
 SELECT overall_officials.nct_id,
    array_to_string(array_agg(overall_officials.affiliation), '|'::text) AS names
   FROM ctgov_beta.overall_officials
  GROUP BY overall_officials.nct_id;


--
-- Name: all_overall_officials; Type: VIEW; Schema: ctgov_beta; Owner: -
--

CREATE VIEW ctgov_beta.all_overall_officials AS
 SELECT overall_officials.nct_id,
...
--
-- Name: all_primary_outcome_measures; Type: VIEW; Schema: ctgov_beta; Owner: -
--

CREATE VIEW ctgov_beta.all_primary_outcome_measures AS
 SELECT design_outcomes.nct_id,
    array_to_string(array_agg(DISTINCT design_outcomes.measure), '|'::text) AS names
   FROM ctgov_beta.design_outcomes
...
--
-- Name: all_secondary_outcome_measures; Type: VIEW; Schema: ctgov_beta; Owner: -
--

CREATE VIEW ctgov_beta.all_secondary_outcome_measures AS
 SELECT design_outcomes.nct_id,
    array_to_string(array_agg(DISTINCT design_outcomes.measure), '|'::text) AS names
   FROM ctgov_beta.design_outcomes
...
--
-- Name: sponsors; Type: TABLE; Schema: ctgov_beta; Owner: -
--

CREATE TABLE ctgov_beta.sponsors (
    id integer NOT NULL,
    nct_id character varying,
    agency_class character varying,
    lead_or_collaborator character varying,
...
--
-- Name: all_sponsors; Type: VIEW; Schema: ctgov_beta; Owner: -
--

CREATE VIEW ctgov_beta.all_sponsors AS
 SELECT sponsors.nct_id,
    array_to_string(array_agg(DISTINCT sponsors.name), '|'::text) AS names
   FROM ctgov_beta.sponsors
  GROUP BY sponsors.nct_id;


--
-- Name: all_states; Type: VIEW; Schema: ctgov_beta; Owner: -
--

CREATE VIEW ctgov_beta.all_states AS
 SELECT facilities.nct_id,
...
--
-- Name: ar_internal_metadata; Type: TABLE; Schema: ctgov_beta; Owner: -
--

CREATE TABLE ctgov_beta.ar_internal_metadata (
    key character varying NOT NULL,
    value character varying,
    created_at timestamp(6) without time zone NOT NULL,
    updated_at timestamp(6) without time zone NOT NULL
...
--
-- Name: baseline_counts; Type: TABLE; Schema: ctgov_beta; Owner: -
--

CREATE TABLE ctgov_beta.baseline_counts (
    id integer NOT NULL,
    nct_id character varying,
    result_group_id integer,
    ctgov_beta_group_code character varying,
    units character varying,
    scope character varying,
    count integer
);
...
--
-- Name: baseline_counts_id_seq; Type: SEQUENCE; Schema: ctgov_beta; Owner: -
--

CREATE SEQUENCE ctgov_beta.baseline_counts_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
--
-- Name: baseline_counts_id_seq; Type: SEQUENCE OWNED BY; Schema: ctgov_beta; Owner: -
--

ALTER SEQUENCE ctgov_beta.baseline_counts_id_seq OWNED BY ctgov_beta.baseline_counts.id;


--
-- Name: baseline_measurements; Type: TABLE; Schema: ctgov_beta; Owner: -
--

CREATE TABLE ctgov_beta.baseline_measurements (
    id integer NOT NULL,
    nct_id character varying,
    result_group_id integer,
    ctgov_beta_group_code character varying,
...
--
-- Name: baseline_measurements_id_seq; Type: SEQUENCE; Schema: ctgov_beta; Owner: -
--

CREATE SEQUENCE ctgov_beta.baseline_measurements_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
--
-- Name: baseline_measurements_id_seq; Type: SEQUENCE OWNED BY; Schema: ctgov_beta; Owner: -
--

ALTER SEQUENCE ctgov_beta.baseline_measurements_id_seq OWNED BY ctgov_beta.baseline_measurements.id;


--
-- Name: brief_summaries; Type: TABLE; Schema: ctgov_beta; Owner: -
--

CREATE TABLE ctgov_beta.brief_summaries (
    id integer NOT NULL,
    nct_id character varying,
    description text
);
...
--
-- Name: brief_summaries_id_seq; Type: SEQUENCE; Schema: ctgov_beta; Owner: -
--

CREATE SEQUENCE ctgov_beta.brief_summaries_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
--
-- Name: brief_summaries_id_seq; Type: SEQUENCE OWNED BY; Schema: ctgov_beta; Owner: -
--

ALTER SEQUENCE ctgov_beta.brief_summaries_id_seq OWNED BY ctgov_beta.brief_summaries.id;


--
-- Name: browse_conditions_id_seq; Type: SEQUENCE; Schema: ctgov_beta; Owner: -
--

CREATE SEQUENCE ctgov_beta.browse_conditions_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
--
-- Name: browse_conditions_id_seq; Type: SEQUENCE OWNED BY; Schema: ctgov_beta; Owner: -
--

ALTER SEQUENCE ctgov_beta.browse_conditions_id_seq OWNED BY ctgov_beta.browse_conditions.id;


--
-- Name: browse_interventions_id_seq; Type: SEQUENCE; Schema: ctgov_beta; Owner: -
--

CREATE SEQUENCE ctgov_beta.browse_interventions_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
--
-- Name: browse_interventions_id_seq; Type: SEQUENCE OWNED BY; Schema: ctgov_beta; Owner: -
--

ALTER SEQUENCE ctgov_beta.browse_interventions_id_seq OWNED BY ctgov_beta.browse_interventions.id;


--
-- Name: calculated_values; Type: TABLE; Schema: ctgov_beta; Owner: -
--

CREATE TABLE ctgov_beta.calculated_values (
    id integer NOT NULL,
    nct_id character varying,
    number_of_facilities integer,
    number_of_nsae_subjects integer,
...
--
-- Name: calculated_values_id_seq; Type: SEQUENCE; Schema: ctgov_beta; Owner: -
--

CREATE SEQUENCE ctgov_beta.calculated_values_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
--
-- Name: calculated_values_id_seq; Type: SEQUENCE OWNED BY; Schema: ctgov_beta; Owner: -
--

ALTER SEQUENCE ctgov_beta.calculated_values_id_seq OWNED BY ctgov_beta.calculated_values.id;


--
-- Name: search_results; Type: TABLE; Schema: ctgov_beta; Owner: -
--

CREATE TABLE ctgov_beta.search_results (
    id integer NOT NULL,
    nct_id character varying NOT NULL,
    name character varying NOT NULL,
    created_at timestamp without time zone NOT NULL,
...
--
-- Name: categories; Type: VIEW; Schema: ctgov_beta; Owner: -
--

CREATE VIEW ctgov_beta.categories AS
 SELECT search_results.id,
    search_results.nct_id,
    search_results.name,
    search_results.created_at,
...
--
-- Name: central_contacts; Type: TABLE; Schema: ctgov_beta; Owner: -
--

CREATE TABLE ctgov_beta.central_contacts (
    id integer NOT NULL,
    nct_id character varying,
    contact_type character varying,
    name character varying,
...
--
-- Name: central_contacts_id_seq; Type: SEQUENCE; Schema: ctgov_beta; Owner: -
--

CREATE SEQUENCE ctgov_beta.central_contacts_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
--
-- Name: central_contacts_id_seq; Type: SEQUENCE OWNED BY; Schema: ctgov_beta; Owner: -
--

ALTER SEQUENCE ctgov_beta.central_contacts_id_seq OWNED BY ctgov_beta.central_contacts.id;


--
-- Name: conditions_id_seq; Type: SEQUENCE; Schema: ctgov_beta; Owner: -
--

CREATE SEQUENCE ctgov_beta.conditions_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
--
-- Name: conditions_id_seq; Type: SEQUENCE OWNED BY; Schema: ctgov_beta; Owner: -
--

ALTER SEQUENCE ctgov_beta.conditions_id_seq OWNED BY ctgov_beta.conditions.id;


--
-- Name: countries_id_seq; Type: SEQUENCE; Schema: ctgov_beta; Owner: -
--

CREATE SEQUENCE ctgov_beta.countries_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
--
-- Name: countries_id_seq; Type: SEQUENCE OWNED BY; Schema: ctgov_beta; Owner: -
--

ALTER SEQUENCE ctgov_beta.countries_id_seq OWNED BY ctgov_beta.countries.id;


--
-- Name: designs; Type: TABLE; Schema: ctgov_beta; Owner: -
--

CREATE TABLE ctgov_beta.designs (
    id integer NOT NULL,
    nct_id character varying,
    allocation character varying,
    intervention_model character varying,
...
--
-- Name: detailed_descriptions; Type: TABLE; Schema: ctgov_beta; Owner: -
--

CREATE TABLE ctgov_beta.detailed_descriptions (
    id integer NOT NULL,
    nct_id character varying,
    description text
);
...
--
-- Name: eligibilities; Type: TABLE; Schema: ctgov_beta; Owner: -
--

CREATE TABLE ctgov_beta.eligibilities (
    id integer NOT NULL,
    nct_id character varying,
    sampling_method character varying,
    gender character varying,
...
--
-- Name: studies; Type: TABLE; Schema: ctgov_beta; Owner: -
--

CREATE TABLE ctgov_beta.studies (
    nct_id character varying,
    nlm_download_date_description character varying,
    study_first_submitted_date date,
    results_first_submitted_date date,
...
--
-- Name: covid_19_studies; Type: VIEW; Schema: ctgov_beta; Owner: -
--

CREATE VIEW ctgov_beta.covid_19_studies AS
 SELECT s.nct_id,
    s.overall_status,
    s.study_type,
    s.official_title,
   ...
   FROM (((((((((((ctgov_beta.studies s
     FULL JOIN ctgov_beta.all_conditions ac ON (((s.nct_id)::text = (ac.nct_id)::text)))
     FULL JOIN ctgov_beta.all_id_information aid ON (((s.nct_id)::text = (aid.nct_id)::text)))
     FULL JOIN ctgov_beta.all_design_outcomes ado ON (((s.nct_id)::text = (ado.nct_id)::text)))
     FULL JOIN ctgov_beta.all_keywords ak ON (((s.nct_id)::text = (ak.nct_id)::text)))
     FULL JOIN ctgov_beta.all_interventions ai ON (((s.nct_id)::text = (ai.nct_id)::text)))
     FULL JOIN ctgov_beta.sponsors sp ON (((s.nct_id)::text = (sp.nct_id)::text)))
     FULL JOIN ctgov_beta.calculated_values cv ON (((s.nct_id)::text = (cv.nct_id)::text)))
     FULL JOIN ctgov_beta.designs d ON (((s.nct_id)::text = (d.nct_id)::text)))
     FULL JOIN ctgov_beta.eligibilities e ON (((s.nct_id)::text = (e.nct_id)::text)))
     FULL JOIN ctgov_beta.brief_summaries bs ON (((s.nct_id)::text = (bs.nct_id)::text)))
     FULL JOIN ctgov_beta.detailed_descriptions dd ON (((s.nct_id)::text = (dd.nct_id)::text)))
...
--
-- Name: design_group_interventions; Type: TABLE; Schema: ctgov_beta; Owner: -
--

CREATE TABLE ctgov_beta.design_group_interventions (
    id integer NOT NULL,
    nct_id character varying,
    design_group_id integer,
    intervention_id integer
...
--
-- Name: design_group_interventions_id_seq; Type: SEQUENCE; Schema: ctgov_beta; Owner: -
--

CREATE SEQUENCE ctgov_beta.design_group_interventions_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
--
-- Name: design_group_interventions_id_seq; Type: SEQUENCE OWNED BY; Schema: ctgov_beta; Owner: -
--

ALTER SEQUENCE ctgov_beta.design_group_interventions_id_seq OWNED BY ctgov_beta.design_group_interventions.id;


--
-- Name: design_groups_id_seq; Type: SEQUENCE; Schema: ctgov_beta; Owner: -
--

CREATE SEQUENCE ctgov_beta.design_groups_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
--
-- Name: design_groups_id_seq; Type: SEQUENCE OWNED BY; Schema: ctgov_beta; Owner: -
--

ALTER SEQUENCE ctgov_beta.design_groups_id_seq OWNED BY ctgov_beta.design_groups.id;


--
-- Name: design_outcomes_id_seq; Type: SEQUENCE; Schema: ctgov_beta; Owner: -
--

CREATE SEQUENCE ctgov_beta.design_outcomes_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
--
-- Name: design_outcomes_id_seq; Type: SEQUENCE OWNED BY; Schema: ctgov_beta; Owner: -
--

ALTER SEQUENCE ctgov_beta.design_outcomes_id_seq OWNED BY ctgov_beta.design_outcomes.id;


--
-- Name: designs_id_seq; Type: SEQUENCE; Schema: ctgov_beta; Owner: -
--

CREATE SEQUENCE ctgov_beta.designs_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
--
-- Name: designs_id_seq; Type: SEQUENCE OWNED BY; Schema: ctgov_beta; Owner: -
--

ALTER SEQUENCE ctgov_beta.designs_id_seq OWNED BY ctgov_beta.designs.id;


--
-- Name: detailed_descriptions_id_seq; Type: SEQUENCE; Schema: ctgov_beta; Owner: -
--

CREATE SEQUENCE ctgov_beta.detailed_descriptions_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
--
-- Name: detailed_descriptions_id_seq; Type: SEQUENCE OWNED BY; Schema: ctgov_beta; Owner: -
--

ALTER SEQUENCE ctgov_beta.detailed_descriptions_id_seq OWNED BY ctgov_beta.detailed_descriptions.id;


--
-- Name: documents; Type: TABLE; Schema: ctgov_beta; Owner: -
--

CREATE TABLE ctgov_beta.documents (
    id integer NOT NULL,
    nct_id character varying,
    document_id character varying,
    document_type character varying,
...
--
-- Name: documents_id_seq; Type: SEQUENCE; Schema: ctgov_beta; Owner: -
--

CREATE SEQUENCE ctgov_beta.documents_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
--
-- Name: documents_id_seq; Type: SEQUENCE OWNED BY; Schema: ctgov_beta; Owner: -
--

ALTER SEQUENCE ctgov_beta.documents_id_seq OWNED BY ctgov_beta.documents.id;


--
-- Name: drop_withdrawals; Type: TABLE; Schema: ctgov_beta; Owner: -
--

CREATE TABLE ctgov_beta.drop_withdrawals (
    id integer NOT NULL,
    nct_id character varying,
    result_group_id integer,
    ctgov_beta_group_code character varying,
...
--
-- Name: drop_withdrawals_id_seq; Type: SEQUENCE; Schema: ctgov_beta; Owner: -
--

CREATE SEQUENCE ctgov_beta.drop_withdrawals_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
--
-- Name: drop_withdrawals_id_seq; Type: SEQUENCE OWNED BY; Schema: ctgov_beta; Owner: -
--

ALTER SEQUENCE ctgov_beta.drop_withdrawals_id_seq OWNED BY ctgov_beta.drop_withdrawals.id;


--
-- Name: eligibilities_id_seq; Type: SEQUENCE; Schema: ctgov_beta; Owner: -
--

CREATE SEQUENCE ctgov_beta.eligibilities_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
--
-- Name: eligibilities_id_seq; Type: SEQUENCE OWNED BY; Schema: ctgov_beta; Owner: -
--

ALTER SEQUENCE ctgov_beta.eligibilities_id_seq OWNED BY ctgov_beta.eligibilities.id;


--
-- Name: facilities_id_seq; Type: SEQUENCE; Schema: ctgov_beta; Owner: -
--

CREATE SEQUENCE ctgov_beta.facilities_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
--
-- Name: facilities_id_seq; Type: SEQUENCE OWNED BY; Schema: ctgov_beta; Owner: -
--

ALTER SEQUENCE ctgov_beta.facilities_id_seq OWNED BY ctgov_beta.facilities.id;


--
-- Name: facility_contacts; Type: TABLE; Schema: ctgov_beta; Owner: -
--

CREATE TABLE ctgov_beta.facility_contacts (
    id integer NOT NULL,
    nct_id character varying,
    facility_id integer,
    contact_type character varying,
...
--
-- Name: facility_contacts_id_seq; Type: SEQUENCE; Schema: ctgov_beta; Owner: -
--

CREATE SEQUENCE ctgov_beta.facility_contacts_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
--
-- Name: facility_contacts_id_seq; Type: SEQUENCE OWNED BY; Schema: ctgov_beta; Owner: -
--

ALTER SEQUENCE ctgov_beta.facility_contacts_id_seq OWNED BY ctgov_beta.facility_contacts.id;


--
-- Name: facility_investigators; Type: TABLE; Schema: ctgov_beta; Owner: -
--

CREATE TABLE ctgov_beta.facility_investigators (
    id integer NOT NULL,
    nct_id character varying,
    facility_id integer,
    role character varying,
...
--
-- Name: facility_investigators_id_seq; Type: SEQUENCE; Schema: ctgov_beta; Owner: -
--

CREATE SEQUENCE ctgov_beta.facility_investigators_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
--
-- Name: facility_investigators_id_seq; Type: SEQUENCE OWNED BY; Schema: ctgov_beta; Owner: -
--

ALTER SEQUENCE ctgov_beta.facility_investigators_id_seq OWNED BY ctgov_beta.facility_investigators.id;


--
-- Name: id_information_id_seq; Type: SEQUENCE; Schema: ctgov_beta; Owner: -
--

CREATE SEQUENCE ctgov_beta.id_information_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
--
-- Name: id_information_id_seq; Type: SEQUENCE OWNED BY; Schema: ctgov_beta; Owner: -
--

ALTER SEQUENCE ctgov_beta.id_information_id_seq OWNED BY ctgov_beta.id_information.id;


--
-- Name: intervention_other_names; Type: TABLE; Schema: ctgov_beta; Owner: -
--

CREATE TABLE ctgov_beta.intervention_other_names (
    id integer NOT NULL,
    nct_id character varying,
    intervention_id integer,
    name character varying
...
--
-- Name: intervention_other_names_id_seq; Type: SEQUENCE; Schema: ctgov_beta; Owner: -
--

CREATE SEQUENCE ctgov_beta.intervention_other_names_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
--
-- Name: intervention_other_names_id_seq; Type: SEQUENCE OWNED BY; Schema: ctgov_beta; Owner: -
--

ALTER SEQUENCE ctgov_beta.intervention_other_names_id_seq OWNED BY ctgov_beta.intervention_other_names.id;


--
-- Name: interventions_id_seq; Type: SEQUENCE; Schema: ctgov_beta; Owner: -
--

CREATE SEQUENCE ctgov_beta.interventions_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
--
-- Name: interventions_id_seq; Type: SEQUENCE OWNED BY; Schema: ctgov_beta; Owner: -
--

ALTER SEQUENCE ctgov_beta.interventions_id_seq OWNED BY ctgov_beta.interventions.id;


--
-- Name: ipd_information_types; Type: TABLE; Schema: ctgov_beta; Owner: -
--

CREATE TABLE ctgov_beta.ipd_information_types (
    id integer NOT NULL,
    nct_id character varying,
    name character varying
);
...
--
-- Name: ipd_information_types_id_seq; Type: SEQUENCE; Schema: ctgov_beta; Owner: -
--

CREATE SEQUENCE ctgov_beta.ipd_information_types_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
--
-- Name: ipd_information_types_id_seq; Type: SEQUENCE OWNED BY; Schema: ctgov_beta; Owner: -
--

ALTER SEQUENCE ctgov_beta.ipd_information_types_id_seq OWNED BY ctgov_beta.ipd_information_types.id;


--
-- Name: keywords_id_seq; Type: SEQUENCE; Schema: ctgov_beta; Owner: -
--

CREATE SEQUENCE ctgov_beta.keywords_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
--
-- Name: keywords_id_seq; Type: SEQUENCE OWNED BY; Schema: ctgov_beta; Owner: -
--

ALTER SEQUENCE ctgov_beta.keywords_id_seq OWNED BY ctgov_beta.keywords.id;


--
-- Name: links; Type: TABLE; Schema: ctgov_beta; Owner: -
--

CREATE TABLE ctgov_beta.links (
    id integer NOT NULL,
    nct_id character varying,
    url character varying,
    description text
...
--
-- Name: links_id_seq; Type: SEQUENCE; Schema: ctgov_beta; Owner: -
--

CREATE SEQUENCE ctgov_beta.links_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
--
-- Name: links_id_seq; Type: SEQUENCE OWNED BY; Schema: ctgov_beta; Owner: -
--

ALTER SEQUENCE ctgov_beta.links_id_seq OWNED BY ctgov_beta.links.id;


--
-- Name: mesh_headings; Type: TABLE; Schema: ctgov_beta; Owner: -
--

CREATE TABLE ctgov_beta.mesh_headings (
    id integer NOT NULL,
    qualifier character varying,
    heading character varying,
    subcategory character varying
...
--
-- Name: mesh_headings_id_seq; Type: SEQUENCE; Schema: ctgov_beta; Owner: -
--

CREATE SEQUENCE ctgov_beta.mesh_headings_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
--
-- Name: mesh_headings_id_seq; Type: SEQUENCE OWNED BY; Schema: ctgov_beta; Owner: -
--

ALTER SEQUENCE ctgov_beta.mesh_headings_id_seq OWNED BY ctgov_beta.mesh_headings.id;


--
-- Name: mesh_terms; Type: TABLE; Schema: ctgov_beta; Owner: -
--

CREATE TABLE ctgov_beta.mesh_terms (
    id integer NOT NULL,
    qualifier character varying,
    tree_number character varying,
    description character varying,
...
--
-- Name: mesh_terms_id_seq; Type: SEQUENCE; Schema: ctgov_beta; Owner: -
--

CREATE SEQUENCE ctgov_beta.mesh_terms_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
--
-- Name: mesh_terms_id_seq; Type: SEQUENCE OWNED BY; Schema: ctgov_beta; Owner: -
--

ALTER SEQUENCE ctgov_beta.mesh_terms_id_seq OWNED BY ctgov_beta.mesh_terms.id;


--
-- Name: milestones; Type: TABLE; Schema: ctgov_beta; Owner: -
--

CREATE TABLE ctgov_beta.milestones (
    id integer NOT NULL,
    nct_id character varying,
    result_group_id integer,
    ctgov_beta_group_code character varying,
...
--
-- Name: milestones_id_seq; Type: SEQUENCE; Schema: ctgov_beta; Owner: -
--

CREATE SEQUENCE ctgov_beta.milestones_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
--
-- Name: milestones_id_seq; Type: SEQUENCE OWNED BY; Schema: ctgov_beta; Owner: -
--

ALTER SEQUENCE ctgov_beta.milestones_id_seq OWNED BY ctgov_beta.milestones.id;


--
-- Name: outcome_analyses; Type: TABLE; Schema: ctgov_beta; Owner: -
--

CREATE TABLE ctgov_beta.outcome_analyses (
    id integer NOT NULL,
    nct_id character varying,
    outcome_id integer,
    non_inferiority_type character varying,
...
--
-- Name: outcome_analyses_id_seq; Type: SEQUENCE; Schema: ctgov_beta; Owner: -
--

CREATE SEQUENCE ctgov_beta.outcome_analyses_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
--
-- Name: outcome_analyses_id_seq; Type: SEQUENCE OWNED BY; Schema: ctgov_beta; Owner: -
--

ALTER SEQUENCE ctgov_beta.outcome_analyses_id_seq OWNED BY ctgov_beta.outcome_analyses.id;


--
-- Name: outcome_analysis_groups; Type: TABLE; Schema: ctgov_beta; Owner: -
--

CREATE TABLE ctgov_beta.outcome_analysis_groups (
    id integer NOT NULL,
    nct_id character varying,
    outcome_analysis_id integer,
    result_group_id integer,
...
--
-- Name: outcome_analysis_groups_id_seq; Type: SEQUENCE; Schema: ctgov_beta; Owner: -
--

CREATE SEQUENCE ctgov_beta.outcome_analysis_groups_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
--
-- Name: outcome_analysis_groups_id_seq; Type: SEQUENCE OWNED BY; Schema: ctgov_beta; Owner: -
--

ALTER SEQUENCE ctgov_beta.outcome_analysis_groups_id_seq OWNED BY ctgov_beta.outcome_analysis_groups.id;


--
-- Name: outcome_counts; Type: TABLE; Schema: ctgov_beta; Owner: -
--

CREATE TABLE ctgov_beta.outcome_counts (
    id integer NOT NULL,
    nct_id character varying,
    outcome_id integer,
    result_group_id integer,
...
--
-- Name: outcome_counts_id_seq; Type: SEQUENCE; Schema: ctgov_beta; Owner: -
--

CREATE SEQUENCE ctgov_beta.outcome_counts_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
--
-- Name: outcome_counts_id_seq; Type: SEQUENCE OWNED BY; Schema: ctgov_beta; Owner: -
--

ALTER SEQUENCE ctgov_beta.outcome_counts_id_seq OWNED BY ctgov_beta.outcome_counts.id;


--
-- Name: outcome_measurements; Type: TABLE; Schema: ctgov_beta; Owner: -
--

CREATE TABLE ctgov_beta.outcome_measurements (
    id integer NOT NULL,
    nct_id character varying,
    outcome_id integer,
    result_group_id integer,
...
--
-- Name: outcome_measurements_id_seq; Type: SEQUENCE; Schema: ctgov_beta; Owner: -
--

CREATE SEQUENCE ctgov_beta.outcome_measurements_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
--
-- Name: outcome_measurements_id_seq; Type: SEQUENCE OWNED BY; Schema: ctgov_beta; Owner: -
--

ALTER SEQUENCE ctgov_beta.outcome_measurements_id_seq OWNED BY ctgov_beta.outcome_measurements.id;


--
-- Name: outcomes; Type: TABLE; Schema: ctgov_beta; Owner: -
--

CREATE TABLE ctgov_beta.outcomes (
    id integer NOT NULL,
    nct_id character varying,
    outcome_type character varying,
    title text,
...
--
-- Name: outcomes_id_seq; Type: SEQUENCE; Schema: ctgov_beta; Owner: -
--

CREATE SEQUENCE ctgov_beta.outcomes_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
--
-- Name: outcomes_id_seq; Type: SEQUENCE OWNED BY; Schema: ctgov_beta; Owner: -
--

ALTER SEQUENCE ctgov_beta.outcomes_id_seq OWNED BY ctgov_beta.outcomes.id;


--
-- Name: overall_officials_id_seq; Type: SEQUENCE; Schema: ctgov_beta; Owner: -
--

CREATE SEQUENCE ctgov_beta.overall_officials_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
--
-- Name: overall_officials_id_seq; Type: SEQUENCE OWNED BY; Schema: ctgov_beta; Owner: -
--

ALTER SEQUENCE ctgov_beta.overall_officials_id_seq OWNED BY ctgov_beta.overall_officials.id;


--
-- Name: participant_flows; Type: TABLE; Schema: ctgov_beta; Owner: -
--

CREATE TABLE ctgov_beta.participant_flows (
    id integer NOT NULL,
    nct_id character varying,
    recruitment_details text,
    pre_assignment_details text
...
--
-- Name: participant_flows_id_seq; Type: SEQUENCE; Schema: ctgov_beta; Owner: -
--

CREATE SEQUENCE ctgov_beta.participant_flows_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
--
-- Name: participant_flows_id_seq; Type: SEQUENCE OWNED BY; Schema: ctgov_beta; Owner: -
--

ALTER SEQUENCE ctgov_beta.participant_flows_id_seq OWNED BY ctgov_beta.participant_flows.id;


--
-- Name: pending_results; Type: TABLE; Schema: ctgov_beta; Owner: -
--

CREATE TABLE ctgov_beta.pending_results (
    id integer NOT NULL,
    nct_id character varying,
    event character varying,
    event_date_description character varying,
...
--
-- Name: pending_results_id_seq; Type: SEQUENCE; Schema: ctgov_beta; Owner: -
--

CREATE SEQUENCE ctgov_beta.pending_results_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
--
-- Name: pending_results_id_seq; Type: SEQUENCE OWNED BY; Schema: ctgov_beta; Owner: -
--

ALTER SEQUENCE ctgov_beta.pending_results_id_seq OWNED BY ctgov_beta.pending_results.id;


--
-- Name: provided_documents; Type: TABLE; Schema: ctgov_beta; Owner: -
--

CREATE TABLE ctgov_beta.provided_documents (
    id integer NOT NULL,
    nct_id character varying,
    document_type character varying,
    has_protocol boolean,
...
--
-- Name: provided_documents_id_seq; Type: SEQUENCE; Schema: ctgov_beta; Owner: -
--

CREATE SEQUENCE ctgov_beta.provided_documents_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
--
-- Name: provided_documents_id_seq; Type: SEQUENCE OWNED BY; Schema: ctgov_beta; Owner: -
--

ALTER SEQUENCE ctgov_beta.provided_documents_id_seq OWNED BY ctgov_beta.provided_documents.id;


--
-- Name: reported_event_totals; Type: TABLE; Schema: ctgov_beta; Owner: -
--

CREATE TABLE ctgov_beta.reported_event_totals (
    id integer NOT NULL,
    nct_id character varying NOT NULL,
    ctgov_beta_group_code character varying NOT NULL,
    event_type character varying,
    classification character varying NOT NULL,
    subjects_affected integer,
    subjects_at_risk integer,
...
--
-- Name: reported_event_totals_id_seq; Type: SEQUENCE; Schema: ctgov_beta; Owner: -
--

CREATE SEQUENCE ctgov_beta.reported_event_totals_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
--
-- Name: reported_event_totals_id_seq; Type: SEQUENCE OWNED BY; Schema: ctgov_beta; Owner: -
--

ALTER SEQUENCE ctgov_beta.reported_event_totals_id_seq OWNED BY ctgov_beta.reported_event_totals.id;


--
-- Name: reported_events; Type: TABLE; Schema: ctgov_beta; Owner: -
--

CREATE TABLE ctgov_beta.reported_events (
    id integer NOT NULL,
    nct_id character varying,
    result_group_id integer,
    ctgov_beta_group_code character varying,
...
--
-- Name: reported_events_id_seq; Type: SEQUENCE; Schema: ctgov_beta; Owner: -
--

CREATE SEQUENCE ctgov_beta.reported_events_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
--
-- Name: reported_events_id_seq; Type: SEQUENCE OWNED BY; Schema: ctgov_beta; Owner: -
--

ALTER SEQUENCE ctgov_beta.reported_events_id_seq OWNED BY ctgov_beta.reported_events.id;


--
-- Name: responsible_parties; Type: TABLE; Schema: ctgov_beta; Owner: -
--

CREATE TABLE ctgov_beta.responsible_parties (
    id integer NOT NULL,
    nct_id character varying,
    responsible_party_type character varying,
    name character varying,
...
--
-- Name: responsible_parties_id_seq; Type: SEQUENCE; Schema: ctgov_beta; Owner: -
--

CREATE SEQUENCE ctgov_beta.responsible_parties_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
--
-- Name: responsible_parties_id_seq; Type: SEQUENCE OWNED BY; Schema: ctgov_beta; Owner: -
--

ALTER SEQUENCE ctgov_beta.responsible_parties_id_seq OWNED BY ctgov_beta.responsible_parties.id;


--
-- Name: result_agreements; Type: TABLE; Schema: ctgov_beta; Owner: -
--

CREATE TABLE ctgov_beta.result_agreements (
    id integer NOT NULL,
    nct_id character varying,
    pi_employee character varying,
    agreement text,
...
--
-- Name: result_agreements_id_seq; Type: SEQUENCE; Schema: ctgov_beta; Owner: -
--

CREATE SEQUENCE ctgov_beta.result_agreements_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
--
-- Name: result_agreements_id_seq; Type: SEQUENCE OWNED BY; Schema: ctgov_beta; Owner: -
--

ALTER SEQUENCE ctgov_beta.result_agreements_id_seq OWNED BY ctgov_beta.result_agreements.id;


--
-- Name: result_contacts; Type: TABLE; Schema: ctgov_beta; Owner: -
--

CREATE TABLE ctgov_beta.result_contacts (
    id integer NOT NULL,
    nct_id character varying,
    organization character varying,
    name character varying,
...
--
-- Name: result_contacts_id_seq; Type: SEQUENCE; Schema: ctgov_beta; Owner: -
--

CREATE SEQUENCE ctgov_beta.result_contacts_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
--
-- Name: result_contacts_id_seq; Type: SEQUENCE OWNED BY; Schema: ctgov_beta; Owner: -
--

ALTER SEQUENCE ctgov_beta.result_contacts_id_seq OWNED BY ctgov_beta.result_contacts.id;


--
-- Name: result_groups; Type: TABLE; Schema: ctgov_beta; Owner: -
--

CREATE TABLE ctgov_beta.result_groups (
    id integer NOT NULL,
    nct_id character varying,
    ctgov_beta_group_code character varying,
    result_type character varying,
...
--
-- Name: result_groups_id_seq; Type: SEQUENCE; Schema: ctgov_beta; Owner: -
--

CREATE SEQUENCE ctgov_beta.result_groups_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
--
-- Name: result_groups_id_seq; Type: SEQUENCE OWNED BY; Schema: ctgov_beta; Owner: -
--

ALTER SEQUENCE ctgov_beta.result_groups_id_seq OWNED BY ctgov_beta.result_groups.id;


--
-- Name: schema_migrations; Type: TABLE; Schema: ctgov_beta; Owner: -
--

CREATE TABLE ctgov_beta.schema_migrations (
    version character varying NOT NULL
);


--
-- Name: search_results_id_seq; Type: SEQUENCE; Schema: ctgov_beta; Owner: -
--

CREATE SEQUENCE ctgov_beta.search_results_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
--
-- Name: search_results_id_seq; Type: SEQUENCE OWNED BY; Schema: ctgov_beta; Owner: -
--

ALTER SEQUENCE ctgov_beta.search_results_id_seq OWNED BY ctgov_beta.search_results.id;


--
-- Name: sponsors_id_seq; Type: SEQUENCE; Schema: ctgov_beta; Owner: -
--

CREATE SEQUENCE ctgov_beta.sponsors_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
--
-- Name: sponsors_id_seq; Type: SEQUENCE OWNED BY; Schema: ctgov_beta; Owner: -
--

ALTER SEQUENCE ctgov_beta.sponsors_id_seq OWNED BY ctgov_beta.sponsors.id;


--
-- Name: study_references; Type: TABLE; Schema: ctgov_beta; Owner: -
--

CREATE TABLE ctgov_beta.study_references (
    id integer NOT NULL,
    nct_id character varying,
    pmid character varying,
    reference_type character varying,
...
--
-- Name: study_references_id_seq; Type: SEQUENCE; Schema: ctgov_beta; Owner: -
--

CREATE SEQUENCE ctgov_beta.study_references_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
--
-- Name: study_references_id_seq; Type: SEQUENCE OWNED BY; Schema: ctgov_beta; Owner: -
--

ALTER SEQUENCE ctgov_beta.study_references_id_seq OWNED BY ctgov_beta.study_references.id;


--
-- Name: study_searches; Type: TABLE; Schema: ctgov_beta; Owner: -
--

CREATE TABLE ctgov_beta.study_searches (
    id integer NOT NULL,
    save_tsv boolean DEFAULT false NOT NULL,
    query character varying NOT NULL,
    "grouping" character varying DEFAULT ''::character varying NOT NULL,
...
--
-- Name: study_searches_id_seq; Type: SEQUENCE; Schema: ctgov_beta; Owner: -
--

CREATE SEQUENCE ctgov_beta.study_searches_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
--
-- Name: study_searches_id_seq; Type: SEQUENCE OWNED BY; Schema: ctgov_beta; Owner: -
--

ALTER SEQUENCE ctgov_beta.study_searches_id_seq OWNED BY ctgov_beta.study_searches.id;
...
--
-- Name: baseline_counts id; Type: DEFAULT; Schema: ctgov_beta; Owner: -
--

ALTER TABLE ONLY ctgov_beta.baseline_counts ALTER COLUMN id SET DEFAULT nextval('ctgov_beta.baseline_counts_id_seq'::regclass);


--
-- Name: baseline_measurements id; Type: DEFAULT; Schema: ctgov_beta; Owner: -
--

ALTER TABLE ONLY ctgov_beta.baseline_measurements ALTER COLUMN id SET DEFAULT nextval('ctgov_beta.baseline_measurements_id_seq'::regclass);


--
-- Name: brief_summaries id; Type: DEFAULT; Schema: ctgov_beta; Owner: -
--

ALTER TABLE ONLY ctgov_beta.brief_summaries ALTER COLUMN id SET DEFAULT nextval('ctgov_beta.brief_summaries_id_seq'::regclass);


--
-- Name: browse_conditions id; Type: DEFAULT; Schema: ctgov_beta; Owner: -
--

ALTER TABLE ONLY ctgov_beta.browse_conditions ALTER COLUMN id SET DEFAULT nextval('ctgov_beta.browse_conditions_id_seq'::regclass);


--
-- Name: browse_interventions id; Type: DEFAULT; Schema: ctgov_beta; Owner: -
--

ALTER TABLE ONLY ctgov_beta.browse_interventions ALTER COLUMN id SET DEFAULT nextval('ctgov_beta.browse_interventions_id_seq'::regclass);


--
-- Name: calculated_values id; Type: DEFAULT; Schema: ctgov_beta; Owner: -
--

ALTER TABLE ONLY ctgov_beta.calculated_values ALTER COLUMN id SET DEFAULT nextval('ctgov_beta.calculated_values_id_seq'::regclass);


--
-- Name: central_contacts id; Type: DEFAULT; Schema: ctgov_beta; Owner: -
--

ALTER TABLE ONLY ctgov_beta.central_contacts ALTER COLUMN id SET DEFAULT nextval('ctgov_beta.central_contacts_id_seq'::regclass);


--
-- Name: conditions id; Type: DEFAULT; Schema: ctgov_beta; Owner: -
--

ALTER TABLE ONLY ctgov_beta.conditions ALTER COLUMN id SET DEFAULT nextval('ctgov_beta.conditions_id_seq'::regclass);


--
-- Name: countries id; Type: DEFAULT; Schema: ctgov_beta; Owner: -
--

ALTER TABLE ONLY ctgov_beta.countries ALTER COLUMN id SET DEFAULT nextval('ctgov_beta.countries_id_seq'::regclass);


--
-- Name: design_group_interventions id; Type: DEFAULT; Schema: ctgov_beta; Owner: -
--

ALTER TABLE ONLY ctgov_beta.design_group_interventions ALTER COLUMN id SET DEFAULT nextval('ctgov_beta.design_group_interventions_id_seq'::regclass);


--
-- Name: design_groups id; Type: DEFAULT; Schema: ctgov_beta; Owner: -
--

ALTER TABLE ONLY ctgov_beta.design_groups ALTER COLUMN id SET DEFAULT nextval('ctgov_beta.design_groups_id_seq'::regclass);


--
-- Name: design_outcomes id; Type: DEFAULT; Schema: ctgov_beta; Owner: -
--

ALTER TABLE ONLY ctgov_beta.design_outcomes ALTER COLUMN id SET DEFAULT nextval('ctgov_beta.design_outcomes_id_seq'::regclass);


--
-- Name: designs id; Type: DEFAULT; Schema: ctgov_beta; Owner: -
--

ALTER TABLE ONLY ctgov_beta.designs ALTER COLUMN id SET DEFAULT nextval('ctgov_beta.designs_id_seq'::regclass);


--
-- Name: detailed_descriptions id; Type: DEFAULT; Schema: ctgov_beta; Owner: -
--

ALTER TABLE ONLY ctgov_beta.detailed_descriptions ALTER COLUMN id SET DEFAULT nextval('ctgov_beta.detailed_descriptions_id_seq'::regclass);


--
-- Name: documents id; Type: DEFAULT; Schema: ctgov_beta; Owner: -
--

ALTER TABLE ONLY ctgov_beta.documents ALTER COLUMN id SET DEFAULT nextval('ctgov_beta.documents_id_seq'::regclass);


--
-- Name: drop_withdrawals id; Type: DEFAULT; Schema: ctgov_beta; Owner: -
--

ALTER TABLE ONLY ctgov_beta.drop_withdrawals ALTER COLUMN id SET DEFAULT nextval('ctgov_beta.drop_withdrawals_id_seq'::regclass);


--
-- Name: eligibilities id; Type: DEFAULT; Schema: ctgov_beta; Owner: -
--

ALTER TABLE ONLY ctgov_beta.eligibilities ALTER COLUMN id SET DEFAULT nextval('ctgov_beta.eligibilities_id_seq'::regclass);


--
-- Name: facilities id; Type: DEFAULT; Schema: ctgov_beta; Owner: -
--

ALTER TABLE ONLY ctgov_beta.facilities ALTER COLUMN id SET DEFAULT nextval('ctgov_beta.facilities_id_seq'::regclass);


--
-- Name: facility_contacts id; Type: DEFAULT; Schema: ctgov_beta; Owner: -
--

ALTER TABLE ONLY ctgov_beta.facility_contacts ALTER COLUMN id SET DEFAULT nextval('ctgov_beta.facility_contacts_id_seq'::regclass);


--
-- Name: facility_investigators id; Type: DEFAULT; Schema: ctgov_beta; Owner: -
--

ALTER TABLE ONLY ctgov_beta.facility_investigators ALTER COLUMN id SET DEFAULT nextval('ctgov_beta.facility_investigators_id_seq'::regclass);


--
-- Name: id_information id; Type: DEFAULT; Schema: ctgov_beta; Owner: -
--

ALTER TABLE ONLY ctgov_beta.id_information ALTER COLUMN id SET DEFAULT nextval('ctgov_beta.id_information_id_seq'::regclass);


--
-- Name: intervention_other_names id; Type: DEFAULT; Schema: ctgov_beta; Owner: -
--

ALTER TABLE ONLY ctgov_beta.intervention_other_names ALTER COLUMN id SET DEFAULT nextval('ctgov_beta.intervention_other_names_id_seq'::regclass);


--
-- Name: interventions id; Type: DEFAULT; Schema: ctgov_beta; Owner: -
--

ALTER TABLE ONLY ctgov_beta.interventions ALTER COLUMN id SET DEFAULT nextval('ctgov_beta.interventions_id_seq'::regclass);


--
-- Name: ipd_information_types id; Type: DEFAULT; Schema: ctgov_beta; Owner: -
--

ALTER TABLE ONLY ctgov_beta.ipd_information_types ALTER COLUMN id SET DEFAULT nextval('ctgov_beta.ipd_information_types_id_seq'::regclass);


--
-- Name: keywords id; Type: DEFAULT; Schema: ctgov_beta; Owner: -
--

ALTER TABLE ONLY ctgov_beta.keywords ALTER COLUMN id SET DEFAULT nextval('ctgov_beta.keywords_id_seq'::regclass);


--
-- Name: links id; Type: DEFAULT; Schema: ctgov_beta; Owner: -
--

ALTER TABLE ONLY ctgov_beta.links ALTER COLUMN id SET DEFAULT nextval('ctgov_beta.links_id_seq'::regclass);


--
-- Name: mesh_headings id; Type: DEFAULT; Schema: ctgov_beta; Owner: -
--

ALTER TABLE ONLY ctgov_beta.mesh_headings ALTER COLUMN id SET DEFAULT nextval('ctgov_beta.mesh_headings_id_seq'::regclass);


--
-- Name: mesh_terms id; Type: DEFAULT; Schema: ctgov_beta; Owner: -
--

ALTER TABLE ONLY ctgov_beta.mesh_terms ALTER COLUMN id SET DEFAULT nextval('ctgov_beta.mesh_terms_id_seq'::regclass);


--
-- Name: milestones id; Type: DEFAULT; Schema: ctgov_beta; Owner: -
--

ALTER TABLE ONLY ctgov_beta.milestones ALTER COLUMN id SET DEFAULT nextval('ctgov_beta.milestones_id_seq'::regclass);


--
-- Name: outcome_analyses id; Type: DEFAULT; Schema: ctgov_beta; Owner: -
--

ALTER TABLE ONLY ctgov_beta.outcome_analyses ALTER COLUMN id SET DEFAULT nextval('ctgov_beta.outcome_analyses_id_seq'::regclass);


--
-- Name: outcome_analysis_groups id; Type: DEFAULT; Schema: ctgov_beta; Owner: -
--

ALTER TABLE ONLY ctgov_beta.outcome_analysis_groups ALTER COLUMN id SET DEFAULT nextval('ctgov_beta.outcome_analysis_groups_id_seq'::regclass);


--
-- Name: outcome_counts id; Type: DEFAULT; Schema: ctgov_beta; Owner: -
--

ALTER TABLE ONLY ctgov_beta.outcome_counts ALTER COLUMN id SET DEFAULT nextval('ctgov_beta.outcome_counts_id_seq'::regclass);


--
-- Name: outcome_measurements id; Type: DEFAULT; Schema: ctgov_beta; Owner: -
--

ALTER TABLE ONLY ctgov_beta.outcome_measurements ALTER COLUMN id SET DEFAULT nextval('ctgov_beta.outcome_measurements_id_seq'::regclass);


--
-- Name: outcomes id; Type: DEFAULT; Schema: ctgov_beta; Owner: -
--

ALTER TABLE ONLY ctgov_beta.outcomes ALTER COLUMN id SET DEFAULT nextval('ctgov_beta.outcomes_id_seq'::regclass);


--
-- Name: overall_officials id; Type: DEFAULT; Schema: ctgov_beta; Owner: -
--

ALTER TABLE ONLY ctgov_beta.overall_officials ALTER COLUMN id SET DEFAULT nextval('ctgov_beta.overall_officials_id_seq'::regclass);


--
-- Name: participant_flows id; Type: DEFAULT; Schema: ctgov_beta; Owner: -
--

ALTER TABLE ONLY ctgov_beta.participant_flows ALTER COLUMN id SET DEFAULT nextval('ctgov_beta.participant_flows_id_seq'::regclass);


--
-- Name: pending_results id; Type: DEFAULT; Schema: ctgov_beta; Owner: -
--

ALTER TABLE ONLY ctgov_beta.pending_results ALTER COLUMN id SET DEFAULT nextval('ctgov_beta.pending_results_id_seq'::regclass);


--
-- Name: provided_documents id; Type: DEFAULT; Schema: ctgov_beta; Owner: -
--

ALTER TABLE ONLY ctgov_beta.provided_documents ALTER COLUMN id SET DEFAULT nextval('ctgov_beta.provided_documents_id_seq'::regclass);


--
-- Name: reported_event_totals id; Type: DEFAULT; Schema: ctgov_beta; Owner: -
--

ALTER TABLE ONLY ctgov_beta.reported_event_totals ALTER COLUMN id SET DEFAULT nextval('ctgov_beta.reported_event_totals_id_seq'::regclass);


--
-- Name: reported_events id; Type: DEFAULT; Schema: ctgov_beta; Owner: -
--

ALTER TABLE ONLY ctgov_beta.reported_events ALTER COLUMN id SET DEFAULT nextval('ctgov_beta.reported_events_id_seq'::regclass);


--
-- Name: responsible_parties id; Type: DEFAULT; Schema: ctgov_beta; Owner: -
--

ALTER TABLE ONLY ctgov_beta.responsible_parties ALTER COLUMN id SET DEFAULT nextval('ctgov_beta.responsible_parties_id_seq'::regclass);


--
-- Name: result_agreements id; Type: DEFAULT; Schema: ctgov_beta; Owner: -
--

ALTER TABLE ONLY ctgov_beta.result_agreements ALTER COLUMN id SET DEFAULT nextval('ctgov_beta.result_agreements_id_seq'::regclass);


--
-- Name: result_contacts id; Type: DEFAULT; Schema: ctgov_beta; Owner: -
--

ALTER TABLE ONLY ctgov_beta.result_contacts ALTER COLUMN id SET DEFAULT nextval('ctgov_beta.result_contacts_id_seq'::regclass);


--
-- Name: result_groups id; Type: DEFAULT; Schema: ctgov_beta; Owner: -
--

ALTER TABLE ONLY ctgov_beta.result_groups ALTER COLUMN id SET DEFAULT nextval('ctgov_beta.result_groups_id_seq'::regclass);


--
-- Name: search_results id; Type: DEFAULT; Schema: ctgov_beta; Owner: -
--

ALTER TABLE ONLY ctgov_beta.search_results ALTER COLUMN id SET DEFAULT nextval('ctgov_beta.search_results_id_seq'::regclass);


--
-- Name: sponsors id; Type: DEFAULT; Schema: ctgov_beta; Owner: -
--

ALTER TABLE ONLY ctgov_beta.sponsors ALTER COLUMN id SET DEFAULT nextval('ctgov_beta.sponsors_id_seq'::regclass);


--
-- Name: study_references id; Type: DEFAULT; Schema: ctgov_beta; Owner: -
--

ALTER TABLE ONLY ctgov_beta.study_references ALTER COLUMN id SET DEFAULT nextval('ctgov_beta.study_references_id_seq'::regclass);


--
-- Name: study_searches id; Type: DEFAULT; Schema: ctgov_beta; Owner: -
--

ALTER TABLE ONLY ctgov_beta.study_searches ALTER COLUMN id SET DEFAULT nextval('ctgov_beta.study_searches_id_seq'::regclass);
...
--
-- Name: ar_internal_metadata ar_internal_metadata_pkey; Type: CONSTRAINT; Schema: ctgov_beta; Owner: -
--

ALTER TABLE ONLY ctgov_beta.ar_internal_metadata
    ADD CONSTRAINT ar_internal_metadata_pkey PRIMARY KEY (key);


--
-- Name: baseline_counts baseline_counts_pkey; Type: CONSTRAINT; Schema: ctgov_beta; Owner: -
--
...
--
-- Name: baseline_measurements baseline_measurements_pkey; Type: CONSTRAINT; Schema: ctgov_beta; Owner: -
--
...
--
-- Name: brief_summaries brief_summaries_pkey; Type: CONSTRAINT; Schema: ctgov_beta; Owner: -
--
...
--
-- Name: browse_conditions browse_conditions_pkey; Type: CONSTRAINT; Schema: ctgov_beta; Owner: -
--
...
--
-- Name: browse_interventions browse_interventions_pkey; Type: CONSTRAINT; Schema: ctgov_beta; Owner: -
--
...
--
-- Name: calculated_values calculated_values_pkey; Type: CONSTRAINT; Schema: ctgov_beta; Owner: -
--
...
--
-- Name: central_contacts central_contacts_pkey; Type: CONSTRAINT; Schema: ctgov_beta; Owner: -
--
...
--
-- Name: conditions conditions_pkey; Type: CONSTRAINT; Schema: ctgov_beta; Owner: -
--
...
--
-- Name: countries countries_pkey; Type: CONSTRAINT; Schema: ctgov_beta; Owner: -
--
...
--
-- Name: design_group_interventions design_group_interventions_pkey; Type: CONSTRAINT; Schema: ctgov_beta; Owner: -
--
...
--
-- Name: design_groups design_groups_pkey; Type: CONSTRAINT; Schema: ctgov_beta; Owner: -
--
...
--
-- Name: design_outcomes design_outcomes_pkey; Type: CONSTRAINT; Schema: ctgov_beta; Owner: -
--
...
--
-- Name: designs designs_pkey; Type: CONSTRAINT; Schema: ctgov_beta; Owner: -
--
...
--
-- Name: detailed_descriptions detailed_descriptions_pkey; Type: CONSTRAINT; Schema: ctgov_beta; Owner: -
--
...
--
-- Name: documents documents_pkey; Type: CONSTRAINT; Schema: ctgov_beta; Owner: -
--
...
--
-- Name: drop_withdrawals drop_withdrawals_pkey; Type: CONSTRAINT; Schema: ctgov_beta; Owner: -
--
...
--
-- Name: eligibilities eligibilities_pkey; Type: CONSTRAINT; Schema: ctgov_beta; Owner: -
--
...
--
-- Name: facilities facilities_pkey; Type: CONSTRAINT; Schema: ctgov_beta; Owner: -
--
...
--
-- Name: facility_contacts facility_contacts_pkey; Type: CONSTRAINT; Schema: ctgov_beta; Owner: -
--
...
--
-- Name: facility_investigators facility_investigators_pkey; Type: CONSTRAINT; Schema: ctgov_beta; Owner: -
--
...
--
-- Name: id_information id_information_pkey; Type: CONSTRAINT; Schema: ctgov_beta; Owner: -
--
...
--
-- Name: intervention_other_names intervention_other_names_pkey; Type: CONSTRAINT; Schema: ctgov_beta; Owner: -
--
...
--
-- Name: interventions interventions_pkey; Type: CONSTRAINT; Schema: ctgov_beta; Owner: -
--
...
--
-- Name: ipd_information_types ipd_information_types_pkey; Type: CONSTRAINT; Schema: ctgov_beta; Owner: -
--
...
--
-- Name: keywords keywords_pkey; Type: CONSTRAINT; Schema: ctgov_beta; Owner: -
--
...
--
-- Name: links links_pkey; Type: CONSTRAINT; Schema: ctgov_beta; Owner: -
--
...
--
-- Name: mesh_headings mesh_headings_pkey; Type: CONSTRAINT; Schema: ctgov_beta; Owner: -
--

ALTER TABLE ONLY ctgov_beta.mesh_headings
    ADD CONSTRAINT mesh_headings_pkey PRIMARY KEY (id);


--
-- Name: mesh_terms mesh_terms_pkey; Type: CONSTRAINT; Schema: ctgov_beta; Owner: -
--

ALTER TABLE ONLY ctgov_beta.mesh_terms
    ADD CONSTRAINT mesh_terms_pkey PRIMARY KEY (id);


--
-- Name: milestones milestones_pkey; Type: CONSTRAINT; Schema: ctgov_beta; Owner: -
--
...
--
-- Name: outcome_analyses outcome_analyses_pkey; Type: CONSTRAINT; Schema: ctgov_beta; Owner: -
--
...
--
-- Name: outcome_analysis_groups outcome_analysis_groups_pkey; Type: CONSTRAINT; Schema: ctgov_beta; Owner: -
--
...
--
-- Name: outcome_counts outcome_counts_pkey; Type: CONSTRAINT; Schema: ctgov_beta; Owner: -
--
...
--
-- Name: outcome_measurements outcome_measurements_pkey; Type: CONSTRAINT; Schema: ctgov_beta; Owner: -
--
...
--
-- Name: outcomes outcomes_pkey; Type: CONSTRAINT; Schema: ctgov_beta; Owner: -
--
...
--
-- Name: overall_officials overall_officials_pkey; Type: CONSTRAINT; Schema: ctgov_beta; Owner: -
--
...
--
-- Name: participant_flows participant_flows_pkey; Type: CONSTRAINT; Schema: ctgov_beta; Owner: -
--
...
--
-- Name: pending_results pending_results_pkey; Type: CONSTRAINT; Schema: ctgov_beta; Owner: -
--
...
--
-- Name: provided_documents provided_documents_pkey; Type: CONSTRAINT; Schema: ctgov_beta; Owner: -
--
...
--
-- Name: reported_event_totals reported_event_totals_pkey; Type: CONSTRAINT; Schema: ctgov_beta; Owner: -
--
...
--
-- Name: reported_events reported_events_pkey; Type: CONSTRAINT; Schema: ctgov_beta; Owner: -
--
...
--
-- Name: responsible_parties responsible_parties_pkey; Type: CONSTRAINT; Schema: ctgov_beta; Owner: -
--
...
--
-- Name: result_agreements result_agreements_pkey; Type: CONSTRAINT; Schema: ctgov_beta; Owner: -
--
...
--
-- Name: result_contacts result_contacts_pkey; Type: CONSTRAINT; Schema: ctgov_beta; Owner: -
--
...
--
-- Name: result_groups result_groups_pkey; Type: CONSTRAINT; Schema: ctgov_beta; Owner: -
--
...
--
-- Name: search_results search_results_pkey; Type: CONSTRAINT; Schema: ctgov_beta; Owner: -
--
...
--
-- Name: sponsors sponsors_pkey; Type: CONSTRAINT; Schema: ctgov_beta; Owner: -
--
...
--
-- Name: study_references study_references_pkey; Type: CONSTRAINT; Schema: ctgov_beta; Owner: -
--
...
--
-- Name: study_searches study_searches_pkey; Type: CONSTRAINT; Schema: ctgov_beta; Owner: -
--

ALTER TABLE ONLY ctgov_beta.study_searches
    ADD CONSTRAINT study_searches_pkey PRIMARY KEY (id);
...
--
-- Name: search_results_nct_idx; Type: INDEX; Schema: ctgov; Owner: -
--

CREATE INDEX search_results_nct_idx ON ctgov.search_results USING btree (nct_id);
...
--
-- Name: baseline_counts_nct_idx; Type: INDEX; Schema: ctgov_beta; Owner: -
--

CREATE INDEX baseline_counts_nct_idx ON ctgov_beta.baseline_counts USING btree (nct_id);


--
-- Name: baseline_measurements_nct_idx; Type: INDEX; Schema: ctgov_beta; Owner: -
--

CREATE INDEX baseline_measurements_nct_idx ON ctgov_beta.baseline_measurements USING btree (nct_id);


--
-- Name: brief_summaries_idx; Type: INDEX; Schema: ctgov_beta; Owner: -
--

CREATE INDEX brief_summaries_idx ON ctgov_beta.brief_summaries USING btree (nct_id);


--
-- Name: brief_summaries_nct_idx; Type: INDEX; Schema: ctgov_beta; Owner: -
--

CREATE INDEX brief_summaries_nct_idx ON ctgov_beta.brief_summaries USING btree (nct_id);


--
-- Name: browse_conditions_nct_idx; Type: INDEX; Schema: ctgov_beta; Owner: -
--

CREATE INDEX browse_conditions_nct_idx ON ctgov_beta.browse_conditions USING btree (nct_id);


--
-- Name: browse_interventions_nct_idx; Type: INDEX; Schema: ctgov_beta; Owner: -
--

CREATE INDEX browse_interventions_nct_idx ON ctgov_beta.browse_interventions USING btree (nct_id);


--
-- Name: calculated_values_nct_idx; Type: INDEX; Schema: ctgov_beta; Owner: -
--

CREATE INDEX calculated_values_nct_idx ON ctgov_beta.calculated_values USING btree (nct_id);


--
-- Name: central_contacts_nct_idx; Type: INDEX; Schema: ctgov_beta; Owner: -
--

CREATE INDEX central_contacts_nct_idx ON ctgov_beta.central_contacts USING btree (nct_id);


--
-- Name: conditions_nct_idx; Type: INDEX; Schema: ctgov_beta; Owner: -
--

CREATE INDEX conditions_nct_idx ON ctgov_beta.conditions USING btree (nct_id);


--
-- Name: countries_nct_idx; Type: INDEX; Schema: ctgov_beta; Owner: -
--

CREATE INDEX countries_nct_idx ON ctgov_beta.countries USING btree (nct_id);


--
-- Name: design_group_interventions_nct_idx; Type: INDEX; Schema: ctgov_beta; Owner: -
--

CREATE INDEX design_group_interventions_nct_idx ON ctgov_beta.design_group_interventions USING btree (nct_id);


--
-- Name: design_groups_nct_idx; Type: INDEX; Schema: ctgov_beta; Owner: -
--

CREATE INDEX design_groups_nct_idx ON ctgov_beta.design_groups USING btree (nct_id);


--
-- Name: design_outcomes_nct_idx; Type: INDEX; Schema: ctgov_beta; Owner: -
--

CREATE INDEX design_outcomes_nct_idx ON ctgov_beta.design_outcomes USING btree (nct_id);


--
-- Name: designs_nct_idx; Type: INDEX; Schema: ctgov_beta; Owner: -
--

CREATE INDEX designs_nct_idx ON ctgov_beta.designs USING btree (nct_id);


--
-- Name: detailed_descriptions_nct_idx; Type: INDEX; Schema: ctgov_beta; Owner: -
--

CREATE INDEX detailed_descriptions_nct_idx ON ctgov_beta.detailed_descriptions USING btree (nct_id);


--
-- Name: documents_nct_idx; Type: INDEX; Schema: ctgov_beta; Owner: -
--

CREATE INDEX documents_nct_idx ON ctgov_beta.documents USING btree (nct_id);


--
-- Name: drop_withdrawals_nct_idx; Type: INDEX; Schema: ctgov_beta; Owner: -
--

CREATE INDEX drop_withdrawals_nct_idx ON ctgov_beta.drop_withdrawals USING btree (nct_id);


--
-- Name: eligibilities_nct_idx; Type: INDEX; Schema: ctgov_beta; Owner: -
--

CREATE INDEX eligibilities_nct_idx ON ctgov_beta.eligibilities USING btree (nct_id);


--
-- Name: facilities_nct_idx; Type: INDEX; Schema: ctgov_beta; Owner: -
--

CREATE INDEX facilities_nct_idx ON ctgov_beta.facilities USING btree (nct_id);


--
-- Name: facility_contacts_nct_idx; Type: INDEX; Schema: ctgov_beta; Owner: -
--

CREATE INDEX facility_contacts_nct_idx ON ctgov_beta.facility_contacts USING btree (nct_id);


--
-- Name: facility_investigators_nct_idx; Type: INDEX; Schema: ctgov_beta; Owner: -
--

CREATE INDEX facility_investigators_nct_idx ON ctgov_beta.facility_investigators USING btree (nct_id);


--
-- Name: id_information_nct_idx; Type: INDEX; Schema: ctgov_beta; Owner: -
--

CREATE INDEX id_information_nct_idx ON ctgov_beta.id_information USING btree (nct_id);
...
CREATE INDEX index_mesh_headings_on_qualifier ON ctgov_beta.mesh_headings USING btree (qualifier);


--
-- Name: index_mesh_terms_on_description; Type: INDEX; Schema: ctgov_beta; Owner: -
--

CREATE INDEX index_mesh_terms_on_description ON ctgov_beta.mesh_terms USING btree (description);


--
-- Name: index_mesh_terms_on_downcase_mesh_term; Type: INDEX; Schema: ctgov_beta; Owner: -
--

CREATE INDEX index_mesh_terms_on_downcase_mesh_term ON ctgov_beta.mesh_terms USING btree (downcase_mesh_term);


--
-- Name: index_mesh_terms_on_mesh_term; Type: INDEX; Schema: ctgov_beta; Owner: -
--

CREATE INDEX index_mesh_terms_on_mesh_term ON ctgov_beta.mesh_terms USING btree (mesh_term);


--
-- Name: index_mesh_terms_on_qualifier; Type: INDEX; Schema: ctgov_beta; Owner: -
--

CREATE INDEX index_mesh_terms_on_qualifier ON ctgov_beta.mesh_terms USING btree (qualifier);
...
--
-- Name: index_study_searches_on_query_and_grouping; Type: INDEX; Schema: ctgov_beta; Owner: -
--

CREATE UNIQUE INDEX index_study_searches_on_query_and_grouping ON ctgov_beta.study_searches USING btree (query, "grouping");


--
-- Name: intervention_other_names_nct_idx; Type: INDEX; Schema: ctgov_beta; Owner: -
--

CREATE INDEX intervention_other_names_nct_idx ON ctgov_beta.intervention_other_names USING btree (nct_id);


--
-- Name: interventions_nct_idx; Type: INDEX; Schema: ctgov_beta; Owner: -
--

CREATE INDEX interventions_nct_idx ON ctgov_beta.interventions USING btree (nct_id);


--
-- Name: ipd_information_types_nct_idx; Type: INDEX; Schema: ctgov_beta; Owner: -
--

CREATE INDEX ipd_information_types_nct_idx ON ctgov_beta.ipd_information_types USING btree (nct_id);


--
-- Name: keywords_nct_idx; Type: INDEX; Schema: ctgov_beta; Owner: -
--

CREATE INDEX keywords_nct_idx ON ctgov_beta.keywords USING btree (nct_id);


--
-- Name: links_nct_idx; Type: INDEX; Schema: ctgov_beta; Owner: -
--

CREATE INDEX links_nct_idx ON ctgov_beta.links USING btree (nct_id);


--
-- Name: milestones_nct_idx; Type: INDEX; Schema: ctgov_beta; Owner: -
--

CREATE INDEX milestones_nct_idx ON ctgov_beta.milestones USING btree (nct_id);


--
-- Name: outcome_analyses_nct_idx; Type: INDEX; Schema: ctgov_beta; Owner: -
--

CREATE INDEX outcome_analyses_nct_idx ON ctgov_beta.outcome_analyses USING btree (nct_id);


--
-- Name: outcome_analysis_groups_nct_idx; Type: INDEX; Schema: ctgov_beta; Owner: -
--

CREATE INDEX outcome_analysis_groups_nct_idx ON ctgov_beta.outcome_analysis_groups USING btree (nct_id);


--
-- Name: outcome_counts_nct_idx; Type: INDEX; Schema: ctgov_beta; Owner: -
--

CREATE INDEX outcome_counts_nct_idx ON ctgov_beta.outcome_counts USING btree (nct_id);


--
-- Name: outcome_measurements_nct_idx; Type: INDEX; Schema: ctgov_beta; Owner: -
--

CREATE INDEX outcome_measurements_nct_idx ON ctgov_beta.outcome_measurements USING btree (nct_id);


--
-- Name: outcomes_nct_idx; Type: INDEX; Schema: ctgov_beta; Owner: -
--

CREATE INDEX outcomes_nct_idx ON ctgov_beta.outcomes USING btree (nct_id);


--
-- Name: overall_officials_nct_idx; Type: INDEX; Schema: ctgov_beta; Owner: -
--

CREATE INDEX overall_officials_nct_idx ON ctgov_beta.overall_officials USING btree (nct_id);


--
-- Name: participant_flows_nct_idx; Type: INDEX; Schema: ctgov_beta; Owner: -
--

CREATE INDEX participant_flows_nct_idx ON ctgov_beta.participant_flows USING btree (nct_id);


--
-- Name: pending_results_nct_idx; Type: INDEX; Schema: ctgov_beta; Owner: -
--

CREATE INDEX pending_results_nct_idx ON ctgov_beta.pending_results USING btree (nct_id);


--
-- Name: provided_documents_nct_idx; Type: INDEX; Schema: ctgov_beta; Owner: -
--

CREATE INDEX provided_documents_nct_idx ON ctgov_beta.provided_documents USING btree (nct_id);


--
-- Name: reported_event_totals_nct_idx; Type: INDEX; Schema: ctgov_beta; Owner: -
--

CREATE INDEX reported_event_totals_nct_idx ON ctgov_beta.reported_event_totals USING btree (nct_id);


--
-- Name: reported_events_nct_idx; Type: INDEX; Schema: ctgov_beta; Owner: -
--

CREATE INDEX reported_events_nct_idx ON ctgov_beta.reported_events USING btree (nct_id);


--
-- Name: responsible_parties_nct_idx; Type: INDEX; Schema: ctgov_beta; Owner: -
--

CREATE INDEX responsible_parties_nct_idx ON ctgov_beta.responsible_parties USING btree (nct_id);


--
-- Name: result_agreements_nct_idx; Type: INDEX; Schema: ctgov_beta; Owner: -
--

CREATE INDEX result_agreements_nct_idx ON ctgov_beta.result_agreements USING btree (nct_id);


--
-- Name: result_contacts_nct_idx; Type: INDEX; Schema: ctgov_beta; Owner: -
--

CREATE INDEX result_contacts_nct_idx ON ctgov_beta.result_contacts USING btree (nct_id);


--
-- Name: result_groups_nct_idx; Type: INDEX; Schema: ctgov_beta; Owner: -
--

CREATE INDEX result_groups_nct_idx ON ctgov_beta.result_groups USING btree (nct_id);


--
-- Name: search_results_nct_idx; Type: INDEX; Schema: ctgov_beta; Owner: -
--

CREATE INDEX search_results_nct_idx ON ctgov_beta.search_results USING btree (nct_id);


--
-- Name: sponsors_nct_idx; Type: INDEX; Schema: ctgov_beta; Owner: -
--

CREATE INDEX sponsors_nct_idx ON ctgov_beta.sponsors USING btree (nct_id);


--
-- Name: studies_nct_idx; Type: INDEX; Schema: ctgov_beta; Owner: -
--

CREATE INDEX studies_nct_idx ON ctgov_beta.studies USING btree (nct_id);


--
-- Name: study_references_nct_idx; Type: INDEX; Schema: ctgov_beta; Owner: -
--

CREATE INDEX study_references_nct_idx ON ctgov_beta.study_references USING btree (nct_id);


--
-- Name: unique_schema_migrations; Type: INDEX; Schema: ctgov_beta; Owner: -
--

CREATE UNIQUE INDEX unique_schema_migrations ON ctgov_beta.schema_migrations USING btree (version);
