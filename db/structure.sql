...
CREATE TABLE ctgov.participant_flows (
    ...
    units_analyzed character varying,
    drop_withdrawal character varying
);
...
--
-- Name: active_storage_attachments; Type: TABLE; Schema: ctgov_beta; Owner: -
--

CREATE TABLE ctgov_beta.active_storage_attachments (
    id bigint NOT NULL,
    name character varying NOT NULL,
    record_type character varying NOT NULL,
    record_id bigint NOT NULL,
...
--
-- Name: active_storage_attachments_id_seq; Type: SEQUENCE; Schema: ctgov_beta; Owner: -
--

CREATE SEQUENCE ctgov_beta.active_storage_attachments_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: active_storage_attachments_id_seq; Type: SEQUENCE OWNED BY; Schema: ctgov_beta; Owner: -
--

ALTER SEQUENCE ctgov_beta.active_storage_attachments_id_seq OWNED BY ctgov_beta.active_storage_attachments.id;


--
-- Name: active_storage_blobs; Type: TABLE; Schema: ctgov_beta; Owner: -
--

CREATE TABLE ctgov_beta.active_storage_blobs (
    id bigint NOT NULL,
    key character varying NOT NULL,
    filename character varying NOT NULL,
    content_type character varying,
...
--
-- Name: active_storage_blobs_id_seq; Type: SEQUENCE; Schema: ctgov_beta; Owner: -
--

CREATE SEQUENCE ctgov_beta.active_storage_blobs_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: active_storage_blobs_id_seq; Type: SEQUENCE OWNED BY; Schema: ctgov_beta; Owner: -
--

ALTER SEQUENCE ctgov_beta.active_storage_blobs_id_seq OWNED BY ctgov_beta.active_storage_blobs.id;
...
--
-- Name: file_records; Type: TABLE; Schema: ctgov_beta; Owner: -
--

CREATE TABLE ctgov_beta.file_records (
    id bigint NOT NULL,
    filename character varying,
    file_size bigint,
    file_type character varying,
...
--
-- Name: file_records_id_seq; Type: SEQUENCE; Schema: ctgov_beta; Owner: -
--

CREATE SEQUENCE ctgov_beta.file_records_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: file_records_id_seq; Type: SEQUENCE OWNED BY; Schema: ctgov_beta; Owner: -
--

ALTER SEQUENCE ctgov_beta.file_records_id_seq OWNED BY ctgov_beta.file_records.id;
...
--
-- Name: retractions; Type: TABLE; Schema: ctgov_beta; Owner: -
--

CREATE TABLE ctgov_beta.retractions (
    id bigint NOT NULL,
    reference_id integer,
    pmid character varying,
    source character varying,
...
--
-- Name: retractions_id_seq; Type: SEQUENCE; Schema: ctgov_beta; Owner: -
--

CREATE SEQUENCE ctgov_beta.retractions_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: retractions_id_seq; Type: SEQUENCE OWNED BY; Schema: ctgov_beta; Owner: -
--

ALTER SEQUENCE ctgov_beta.retractions_id_seq OWNED BY ctgov_beta.retractions.id;
...
--
-- Name: verifiers; Type: TABLE; Schema: ctgov_beta; Owner: -
--

CREATE TABLE ctgov_beta.verifiers (
    id bigint NOT NULL,
    differences json DEFAULT '[]'::json NOT NULL,
    last_run timestamp without time zone,
    source json,
...
--
-- Name: verifiers_id_seq; Type: SEQUENCE; Schema: ctgov_beta; Owner: -
--

CREATE SEQUENCE ctgov_beta.verifiers_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: verifiers_id_seq; Type: SEQUENCE OWNED BY; Schema: ctgov_beta; Owner: -
--

ALTER SEQUENCE ctgov_beta.verifiers_id_seq OWNED BY ctgov_beta.verifiers.id;
...
--
-- Name: active_storage_attachments id; Type: DEFAULT; Schema: ctgov_beta; Owner: -
--

ALTER TABLE ONLY ctgov_beta.active_storage_attachments ALTER COLUMN id SET DEFAULT nextval('ctgov_beta.active_storage_attachments_id_seq'::regclass);


--
-- Name: active_storage_blobs id; Type: DEFAULT; Schema: ctgov_beta; Owner: -
--

ALTER TABLE ONLY ctgov_beta.active_storage_blobs ALTER COLUMN id SET DEFAULT nextval('ctgov_beta.active_storage_blobs_id_seq'::regclass);
...
--
-- Name: file_records id; Type: DEFAULT; Schema: ctgov_beta; Owner: -
--

ALTER TABLE ONLY ctgov_beta.file_records ALTER COLUMN id SET DEFAULT nextval('ctgov_beta.file_records_id_seq'::regclass);
...
--
-- Name: retractions id; Type: DEFAULT; Schema: ctgov_beta; Owner: -
--

ALTER TABLE ONLY ctgov_beta.retractions ALTER COLUMN id SET DEFAULT nextval('ctgov_beta.retractions_id_seq'::regclass);
...
--
-- Name: verifiers id; Type: DEFAULT; Schema: ctgov_beta; Owner: -
--

ALTER TABLE ONLY ctgov_beta.verifiers ALTER COLUMN id SET DEFAULT nextval('ctgov_beta.verifiers_id_seq'::regclass);
...
--
-- Name: active_storage_attachments active_storage_attachments_pkey; Type: CONSTRAINT; Schema: ctgov_beta; Owner: -
--

ALTER TABLE ONLY ctgov_beta.active_storage_attachments
    ADD CONSTRAINT active_storage_attachments_pkey PRIMARY KEY (id);


--
-- Name: active_storage_blobs active_storage_blobs_pkey; Type: CONSTRAINT; Schema: ctgov_beta; Owner: -
--

ALTER TABLE ONLY ctgov_beta.active_storage_blobs
    ADD CONSTRAINT active_storage_blobs_pkey PRIMARY KEY (id);
...
--
-- Name: file_records file_records_pkey; Type: CONSTRAINT; Schema: ctgov_beta; Owner: -
--

ALTER TABLE ONLY ctgov_beta.file_records
    ADD CONSTRAINT file_records_pkey PRIMARY KEY (id);
...
--
-- Name: retractions retractions_pkey; Type: CONSTRAINT; Schema: ctgov_beta; Owner: -
--

ALTER TABLE ONLY ctgov_beta.retractions
    ADD CONSTRAINT retractions_pkey PRIMARY KEY (id);


--
-- Name: schema_migrations schema_migrations_pkey; Type: CONSTRAINT; Schema: ctgov_beta; Owner: -
--

ALTER TABLE ONLY ctgov_beta.schema_migrations
    ADD CONSTRAINT schema_migrations_pkey PRIMARY KEY (version);
...
--
-- Name: verifiers verifiers_pkey; Type: CONSTRAINT; Schema: ctgov_beta; Owner: -
--

ALTER TABLE ONLY ctgov_beta.verifiers
    ADD CONSTRAINT verifiers_pkey PRIMARY KEY (id);
...
--
-- Name: index_active_storage_attachments_on_blob_id; Type: INDEX; Schema: ctgov_beta; Owner: -
--

CREATE INDEX index_active_storage_attachments_on_blob_id ON ctgov_beta.active_storage_attachments USING btree (blob_id);


--
-- Name: index_active_storage_attachments_uniqueness; Type: INDEX; Schema: ctgov_beta; Owner: -
--

CREATE UNIQUE INDEX index_active_storage_attachments_uniqueness ON ctgov_beta.active_storage_attachments USING btree (record_type, record_id, name, blob_id);


--
-- Name: index_active_storage_blobs_on_key; Type: INDEX; Schema: ctgov_beta; Owner: -
--

CREATE UNIQUE INDEX index_active_storage_blobs_on_key ON ctgov_beta.active_storage_blobs USING btree (key);
...
--
-- Name: index_id_information_on_id_source; Type: INDEX; Schema: ctgov_beta; Owner: -
--

CREATE INDEX index_id_information_on_id_source ON ctgov_beta.id_information USING btree (id_source);
...
--
-- Name: active_storage_attachments fk_rails_c3b3935057; Type: FK CONSTRAINT; Schema: ctgov_beta; Owner: -
--

ALTER TABLE ONLY ctgov_beta.active_storage_attachments
    ADD CONSTRAINT fk_rails_c3b3935057 FOREIGN KEY (blob_id) REFERENCES ctgov_beta.active_storage_blobs(id);
