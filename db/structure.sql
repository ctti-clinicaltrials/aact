...
--
-- Name: table_saved_querie; Type: TABLE; Schema: ctgov; Owner: -
--

CREATE TABLE ctgov.table_saved_querie (
    id bigint NOT NULL,
    title character varying,
    description character varying,
...
--
-- Name: table_saved_querie_id_seq; Type: SEQUENCE; Schema: ctgov; Owner: -
--

CREATE SEQUENCE ctgov.table_saved_querie_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: table_saved_querie_id_seq; Type: SEQUENCE OWNED BY; Schema: ctgov; Owner: -
--

ALTER SEQUENCE ctgov.table_saved_querie_id_seq OWNED BY ctgov.table_saved_querie.id;
...
--
-- Name: table_saved_querie id; Type: DEFAULT; Schema: ctgov; Owner: -
--

ALTER TABLE ONLY ctgov.table_saved_querie ALTER COLUMN id SET DEFAULT nextval('ctgov.table_saved_querie_id_seq'::regclass);
...
--
-- Name: table_saved_querie table_saved_querie_pkey; Type: CONSTRAINT; Schema: ctgov; Owner: -
--

ALTER TABLE ONLY ctgov.table_saved_querie
    ADD CONSTRAINT table_saved_querie_pkey PRIMARY KEY (id);
...
--
-- Name: index_table_saved_querie_on_user_id; Type: INDEX; Schema: ctgov; Owner: -
--

CREATE INDEX index_table_saved_querie_on_user_id ON ctgov.table_saved_querie USING btree (user_id);
