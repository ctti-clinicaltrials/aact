...
--
-- Name: ctgov_archive; Type: SCHEMA; Schema: -; Owner: -
--

CREATE SCHEMA ctgov_archive;
...
--
-- Name: category_insert_function(); Type: FUNCTION; Schema: ctgov_archive; Owner: -
--

CREATE FUNCTION ctgov_archive.category_insert_function() RETURNS trigger
    LANGUAGE plpgsql
    AS $$
        BEGIN
          INSERT INTO ctgov.search_results (id, nct_id, name, created_at, updated_at, grouping, study_search_id)
...
--
-- Name: count_estimate(text); Type: FUNCTION; Schema: ctgov_archive; Owner: -
--

CREATE FUNCTION ctgov_archive.count_estimate(query text) RETURNS integer
    LANGUAGE plpgsql
    AS $$
      DECLARE
        rec   record;
...
--
-- Name: ids_for_org(character varying); Type: FUNCTION; Schema: ctgov_archive; Owner: -
--

CREATE FUNCTION ctgov_archive.ids_for_org(character varying) RETURNS TABLE(nct_id character varying)
    LANGUAGE sql
    AS $_$
      SELECT DISTINCT nct_id FROM responsible_parties WHERE lower(affiliation) like lower($1)
      UNION
...
--
-- Name: ids_for_term(character varying); Type: FUNCTION; Schema: ctgov_archive; Owner: -
--

CREATE FUNCTION ctgov_archive.ids_for_term(character varying) RETURNS TABLE(nct_id character varying)
    LANGUAGE sql
    AS $_$
...
--
-- Name: study_summaries_for_condition(character varying); Type: FUNCTION; Schema: ctgov_archive; Owner: -
--

CREATE FUNCTION ctgov_archive.study_summaries_for_condition(character varying) RETURNS TABLE(nct_id character varying, title text, recruitment character varying, were_results_reported boolean, conditions text, interventions text, gender character varying, age text, phase character varying, enrollment integer, study_type character varying, sponsors text, other_ids text, study_first_submitted_date date, start_date date, completion_month_year character varying, last_update_submitted_date date, verification_month_year character varying, results_first_submitted_date date, acronym character varying, primary_completion_month_year character varying, outcome_measures text, disposition_first_submitted_date date, allocation character varying, intervention_model character varying, observational_model character varying, primary_purpose character varying, time_perspective character varying, masking character varying, masking_description text, intervention_model_description text, subject_masked boolean, caregiver_masked boolean, investigator_masked boolean, outcomes_assessor_masked boolean, number_of_facilities integer)
    LANGUAGE sql
    AS $_$
...
--
-- Name: browse_conditions; Type: TABLE; Schema: ctgov_archive; Owner: -
--

CREATE TABLE ctgov_archive.browse_conditions (
    id integer NOT NULL,
    nct_id character varying,
    mesh_term character varying,
    downcase_mesh_term character varying,
...
--
-- Name: all_browse_conditions; Type: VIEW; Schema: ctgov_archive; Owner: -
--

CREATE VIEW ctgov_archive.all_browse_conditions AS
 SELECT browse_conditions.nct_id,
    array_to_string(array_agg(DISTINCT browse_conditions.mesh_term), '|'::text) AS names
   FROM ctgov_archive.browse_conditions
  GROUP BY browse_conditions.nct_id;


--
-- Name: browse_interventions; Type: TABLE; Schema: ctgov_archive; Owner: -
--

CREATE TABLE ctgov_archive.browse_interventions (
    id integer NOT NULL,
    nct_id character varying,
    mesh_term character varying,
    downcase_mesh_term character varying,
...
--
-- Name: all_browse_interventions; Type: VIEW; Schema: ctgov_archive; Owner: -
--

CREATE VIEW ctgov_archive.all_browse_interventions AS
 SELECT browse_interventions.nct_id,
    array_to_string(array_agg(browse_interventions.mesh_term), '|'::text) AS names
   FROM ctgov_archive.browse_interventions
  GROUP BY browse_interventions.nct_id;


--
-- Name: facilities; Type: TABLE; Schema: ctgov_archive; Owner: -
--

CREATE TABLE ctgov_archive.facilities (
    id integer NOT NULL,
    nct_id character varying,
    status character varying,
    name character varying,
...
--
-- Name: all_cities; Type: VIEW; Schema: ctgov_archive; Owner: -
--

CREATE VIEW ctgov_archive.all_cities AS
 SELECT facilities.nct_id,
    array_to_string(array_agg(DISTINCT facilities.city), '|'::text) AS names
   FROM ctgov_archive.facilities
  GROUP BY facilities.nct_id;


--
-- Name: conditions; Type: TABLE; Schema: ctgov_archive; Owner: -
--

CREATE TABLE ctgov_archive.conditions (
    id integer NOT NULL,
    nct_id character varying,
    name character varying,
    downcase_name character varying
...
--
-- Name: all_conditions; Type: VIEW; Schema: ctgov_archive; Owner: -
--

CREATE VIEW ctgov_archive.all_conditions AS
 SELECT conditions.nct_id,
    array_to_string(array_agg(DISTINCT conditions.name), '|'::text) AS names
   FROM ctgov_archive.conditions
  GROUP BY conditions.nct_id;


--
-- Name: countries; Type: TABLE; Schema: ctgov_archive; Owner: -
--

CREATE TABLE ctgov_archive.countries (
    id integer NOT NULL,
    nct_id character varying,
    name character varying,
    removed boolean
...
--
-- Name: all_countries; Type: VIEW; Schema: ctgov_archive; Owner: -
--

CREATE VIEW ctgov_archive.all_countries AS
 SELECT countries.nct_id,
    array_to_string(array_agg(DISTINCT countries.name), '|'::text) AS names
   FROM ctgov_archive.countries
  WHERE (countries.removed IS NOT TRUE)
  GROUP BY countries.nct_id;


--
-- Name: design_outcomes; Type: TABLE; Schema: ctgov_archive; Owner: -
--

CREATE TABLE ctgov_archive.design_outcomes (
    id integer NOT NULL,
    nct_id character varying,
    outcome_type character varying,
    measure text,
...
--
-- Name: all_design_outcomes; Type: VIEW; Schema: ctgov_archive; Owner: -
--

CREATE VIEW ctgov_archive.all_design_outcomes AS
 SELECT design_outcomes.nct_id,
    array_to_string(array_agg(DISTINCT design_outcomes.measure), '|'::text) AS names
   FROM ctgov_archive.design_outcomes
  GROUP BY design_outcomes.nct_id;


--
-- Name: all_facilities; Type: VIEW; Schema: ctgov_archive; Owner: -
--

CREATE VIEW ctgov_archive.all_facilities AS
 SELECT facilities.nct_id,
    array_to_string(array_agg(facilities.name), '|'::text) AS names
   FROM ctgov_archive.facilities
  GROUP BY facilities.nct_id;
...
--
-- Name: design_groups; Type: TABLE; Schema: ctgov_archive; Owner: -
--

CREATE TABLE ctgov_archive.design_groups (
    id integer NOT NULL,
    nct_id character varying,
    group_type character varying,
    title character varying,
...
--
-- Name: all_group_types; Type: VIEW; Schema: ctgov_archive; Owner: -
--

CREATE VIEW ctgov_archive.all_group_types AS
 SELECT design_groups.nct_id,
    array_to_string(array_agg(DISTINCT design_groups.group_type), '|'::text) AS names
   FROM ctgov_archive.design_groups
  GROUP BY design_groups.nct_id;


--
-- Name: id_information; Type: TABLE; Schema: ctgov_archive; Owner: -
--

CREATE TABLE ctgov_archive.id_information (
    id integer NOT NULL,
    nct_id character varying,
    id_type character varying,
    id_value character varying
...
--
-- Name: all_id_information; Type: VIEW; Schema: ctgov_archive; Owner: -
--

CREATE VIEW ctgov_archive.all_id_information AS
 SELECT id_information.nct_id,
    array_to_string(array_agg(DISTINCT id_information.id_value), '|'::text) AS names
   FROM ctgov_archive.id_information
  GROUP BY id_information.nct_id;


--
-- Name: interventions; Type: TABLE; Schema: ctgov_archive; Owner: -
--

CREATE TABLE ctgov_archive.interventions (
    id integer NOT NULL,
    nct_id character varying,
    intervention_type character varying,
    name character varying,
...
--
-- Name: all_intervention_types; Type: VIEW; Schema: ctgov_archive; Owner: -
--

CREATE VIEW ctgov_archive.all_intervention_types AS
 SELECT interventions.nct_id,
    array_to_string(array_agg(interventions.intervention_type), '|'::text) AS names
   FROM ctgov_archive.interventions
  GROUP BY interventions.nct_id;


--
-- Name: all_interventions; Type: VIEW; Schema: ctgov_archive; Owner: -
--

CREATE VIEW ctgov_archive.all_interventions AS
 SELECT interventions.nct_id,
    array_to_string(array_agg(interventions.name), '|'::text) AS names
   FROM ctgov_archive.interventions
  GROUP BY interventions.nct_id;
...
--
-- Name: keywords; Type: TABLE; Schema: ctgov_archive; Owner: -
--

CREATE TABLE ctgov_archive.keywords (
    id integer NOT NULL,
    nct_id character varying,
    name character varying,
    downcase_name character varying
...
--
-- Name: all_keywords; Type: VIEW; Schema: ctgov_archive; Owner: -
--

CREATE VIEW ctgov_archive.all_keywords AS
 SELECT keywords.nct_id,
    array_to_string(array_agg(DISTINCT keywords.name), '|'::text) AS names
   FROM ctgov_archive.keywords
  GROUP BY keywords.nct_id;


--
-- Name: overall_officials; Type: TABLE; Schema: ctgov_archive; Owner: -
--

CREATE TABLE ctgov_archive.overall_officials (
    id integer NOT NULL,
    nct_id character varying,
    role character varying,
    name character varying,
...
--
-- Name: all_overall_official_affiliations; Type: VIEW; Schema: ctgov_archive; Owner: -
--

CREATE VIEW ctgov_archive.all_overall_official_affiliations AS
 SELECT overall_officials.nct_id,
    array_to_string(array_agg(overall_officials.affiliation), '|'::text) AS names
   FROM ctgov_archive.overall_officials
  GROUP BY overall_officials.nct_id;


--
-- Name: all_overall_officials; Type: VIEW; Schema: ctgov_archive; Owner: -
--

CREATE VIEW ctgov_archive.all_overall_officials AS
 SELECT overall_officials.nct_id,
    array_to_string(array_agg(overall_officials.name), '|'::text) AS names
   FROM ctgov_archive.overall_officials
  GROUP BY overall_officials.nct_id;
...
--
-- Name: all_primary_outcome_measures; Type: VIEW; Schema: ctgov_archive; Owner: -
--

CREATE VIEW ctgov_archive.all_primary_outcome_measures AS
 SELECT design_outcomes.nct_id,
    array_to_string(array_agg(DISTINCT design_outcomes.measure), '|'::text) AS names
   FROM ctgov_archive.design_outcomes
  WHERE ((design_outcomes.outcome_type)::text = 'primary'::text)
...
--
-- Name: all_secondary_outcome_measures; Type: VIEW; Schema: ctgov_archive; Owner: -
--

CREATE VIEW ctgov_archive.all_secondary_outcome_measures AS
 SELECT design_outcomes.nct_id,
    array_to_string(array_agg(DISTINCT design_outcomes.measure), '|'::text) AS names
   FROM ctgov_archive.design_outcomes
  WHERE ((design_outcomes.outcome_type)::text = 'secondary'::text)
...
--
-- Name: sponsors; Type: TABLE; Schema: ctgov_archive; Owner: -
--

CREATE TABLE ctgov_archive.sponsors (
    id integer NOT NULL,
    nct_id character varying,
    agency_class character varying,
    lead_or_collaborator character varying,
...
--
-- Name: all_sponsors; Type: VIEW; Schema: ctgov_archive; Owner: -
--

CREATE VIEW ctgov_archive.all_sponsors AS
 SELECT sponsors.nct_id,
    array_to_string(array_agg(DISTINCT sponsors.name), '|'::text) AS names
   FROM ctgov_archive.sponsors
  GROUP BY sponsors.nct_id;


--
-- Name: all_states; Type: VIEW; Schema: ctgov_archive; Owner: -
--

CREATE VIEW ctgov_archive.all_states AS
 SELECT facilities.nct_id,
    array_to_string(array_agg(DISTINCT facilities.state), '|'::text) AS names
   FROM ctgov_archive.facilities
  GROUP BY facilities.nct_id;
...
--
-- Name: ar_internal_metadata; Type: TABLE; Schema: ctgov_archive; Owner: -
--

CREATE TABLE ctgov_archive.ar_internal_metadata (
    key character varying NOT NULL,
    value character varying,
    created_at timestamp(6) without time zone NOT NULL,
    updated_at timestamp(6) without time zone NOT NULL
...
--
-- Name: baseline_counts; Type: TABLE; Schema: ctgov_archive; Owner: -
--

CREATE TABLE ctgov_archive.baseline_counts (
    id integer NOT NULL,
    nct_id character varying,
    result_group_id integer,
    ctgov_group_code character varying,
...
--
-- Name: baseline_counts_id_seq; Type: SEQUENCE; Schema: ctgov_archive; Owner: -
--

CREATE SEQUENCE ctgov_archive.baseline_counts_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: baseline_counts_id_seq; Type: SEQUENCE OWNED BY; Schema: ctgov_archive; Owner: -
--

ALTER SEQUENCE ctgov_archive.baseline_counts_id_seq OWNED BY ctgov_archive.baseline_counts.id;


--
-- Name: baseline_measurements; Type: TABLE; Schema: ctgov_archive; Owner: -
--

CREATE TABLE ctgov_archive.baseline_measurements (
    id integer NOT NULL,
    nct_id character varying,
    result_group_id integer,
    ctgov_group_code character varying,
...
--
-- Name: baseline_measurements_id_seq; Type: SEQUENCE; Schema: ctgov_archive; Owner: -
--

CREATE SEQUENCE ctgov_archive.baseline_measurements_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: baseline_measurements_id_seq; Type: SEQUENCE OWNED BY; Schema: ctgov_archive; Owner: -
--

ALTER SEQUENCE ctgov_archive.baseline_measurements_id_seq OWNED BY ctgov_archive.baseline_measurements.id;


--
-- Name: brief_summaries; Type: TABLE; Schema: ctgov_archive; Owner: -
--

CREATE TABLE ctgov_archive.brief_summaries (
    id integer NOT NULL,
    nct_id character varying,
    description text
);
...
--
-- Name: brief_summaries_id_seq; Type: SEQUENCE; Schema: ctgov_archive; Owner: -
--

CREATE SEQUENCE ctgov_archive.brief_summaries_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: brief_summaries_id_seq; Type: SEQUENCE OWNED BY; Schema: ctgov_archive; Owner: -
--

ALTER SEQUENCE ctgov_archive.brief_summaries_id_seq OWNED BY ctgov_archive.brief_summaries.id;


--
-- Name: browse_conditions_id_seq; Type: SEQUENCE; Schema: ctgov_archive; Owner: -
--

CREATE SEQUENCE ctgov_archive.browse_conditions_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: browse_conditions_id_seq; Type: SEQUENCE OWNED BY; Schema: ctgov_archive; Owner: -
--

ALTER SEQUENCE ctgov_archive.browse_conditions_id_seq OWNED BY ctgov_archive.browse_conditions.id;


--
-- Name: browse_interventions_id_seq; Type: SEQUENCE; Schema: ctgov_archive; Owner: -
--

CREATE SEQUENCE ctgov_archive.browse_interventions_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: browse_interventions_id_seq; Type: SEQUENCE OWNED BY; Schema: ctgov_archive; Owner: -
--

ALTER SEQUENCE ctgov_archive.browse_interventions_id_seq OWNED BY ctgov_archive.browse_interventions.id;


--
-- Name: calculated_values; Type: TABLE; Schema: ctgov_archive; Owner: -
--

CREATE TABLE ctgov_archive.calculated_values (
    id integer NOT NULL,
    nct_id character varying,
    number_of_facilities integer,
    number_of_nsae_subjects integer,
...
--
-- Name: calculated_values_id_seq; Type: SEQUENCE; Schema: ctgov_archive; Owner: -
--

CREATE SEQUENCE ctgov_archive.calculated_values_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: calculated_values_id_seq; Type: SEQUENCE OWNED BY; Schema: ctgov_archive; Owner: -
--

ALTER SEQUENCE ctgov_archive.calculated_values_id_seq OWNED BY ctgov_archive.calculated_values.id;


--
-- Name: search_results; Type: TABLE; Schema: ctgov_archive; Owner: -
--

CREATE TABLE ctgov_archive.search_results (
    id integer NOT NULL,
    nct_id character varying NOT NULL,
    name character varying NOT NULL,
    created_at timestamp without time zone NOT NULL,
...
--
-- Name: categories; Type: VIEW; Schema: ctgov_archive; Owner: -
--

CREATE VIEW ctgov_archive.categories AS
 SELECT search_results.id,
    search_results.nct_id,
    search_results.name,
    search_results.created_at,
    ...
    search_results."grouping",
    search_results.study_search_id
   FROM ctgov_archive.search_results;


--
-- Name: categories_id_seq; Type: SEQUENCE; Schema: ctgov_archive; Owner: -
--

CREATE SEQUENCE ctgov_archive.categories_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: central_contacts; Type: TABLE; Schema: ctgov_archive; Owner: -
--

CREATE TABLE ctgov_archive.central_contacts (
    id integer NOT NULL,
    nct_id character varying,
    contact_type character varying,
    name character varying,
...
--
-- Name: central_contacts_id_seq; Type: SEQUENCE; Schema: ctgov_archive; Owner: -
--

CREATE SEQUENCE ctgov_archive.central_contacts_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: central_contacts_id_seq; Type: SEQUENCE OWNED BY; Schema: ctgov_archive; Owner: -
--

ALTER SEQUENCE ctgov_archive.central_contacts_id_seq OWNED BY ctgov_archive.central_contacts.id;


--
-- Name: conditions_id_seq; Type: SEQUENCE; Schema: ctgov_archive; Owner: -
--

CREATE SEQUENCE ctgov_archive.conditions_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: conditions_id_seq; Type: SEQUENCE OWNED BY; Schema: ctgov_archive; Owner: -
--

ALTER SEQUENCE ctgov_archive.conditions_id_seq OWNED BY ctgov_archive.conditions.id;


--
-- Name: countries_id_seq; Type: SEQUENCE; Schema: ctgov_archive; Owner: -
--

CREATE SEQUENCE ctgov_archive.countries_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: countries_id_seq; Type: SEQUENCE OWNED BY; Schema: ctgov_archive; Owner: -
--

ALTER SEQUENCE ctgov_archive.countries_id_seq OWNED BY ctgov_archive.countries.id;


--
-- Name: designs; Type: TABLE; Schema: ctgov_archive; Owner: -
--

CREATE TABLE ctgov_archive.designs (
    id integer NOT NULL,
    nct_id character varying,
    allocation character varying,
    intervention_model character varying,
...
--
-- Name: detailed_descriptions; Type: TABLE; Schema: ctgov_archive; Owner: -
--

CREATE TABLE ctgov_archive.detailed_descriptions (
    id integer NOT NULL,
    nct_id character varying,
    description text
);
...
--
-- Name: eligibilities; Type: TABLE; Schema: ctgov_archive; Owner: -
--

CREATE TABLE ctgov_archive.eligibilities (
    id integer NOT NULL,
    nct_id character varying,
    sampling_method character varying,
    gender character varying,
...
--
-- Name: studies; Type: TABLE; Schema: ctgov_archive; Owner: -
--

CREATE TABLE ctgov_archive.studies (
    nct_id character varying,
    nlm_download_date_description character varying,
    study_first_submitted_date date,
    results_first_submitted_date date,
...
--
-- Name: covid_19_studies; Type: VIEW; Schema: ctgov_archive; Owner: -
--

CREATE VIEW ctgov_archive.covid_19_studies AS
 SELECT s.nct_id,
    s.overall_status,
    s.study_type,
    s.official_title,
    ...
    bs.description AS brief_summary,
    dd.description AS detailed_description
   FROM (((((((((((ctgov_archive.studies s
     FULL JOIN ctgov_archive.all_conditions ac ON (((s.nct_id)::text = (ac.nct_id)::text)))
     FULL JOIN ctgov_archive.all_id_information aid ON (((s.nct_id)::text = (aid.nct_id)::text)))
     FULL JOIN ctgov_archive.all_design_outcomes ado ON (((s.nct_id)::text = (ado.nct_id)::text)))
     FULL JOIN ctgov_archive.all_keywords ak ON (((s.nct_id)::text = (ak.nct_id)::text)))
     FULL JOIN ctgov_archive.all_interventions ai ON (((s.nct_id)::text = (ai.nct_id)::text)))
     FULL JOIN ctgov_archive.sponsors sp ON (((s.nct_id)::text = (sp.nct_id)::text)))
     FULL JOIN ctgov_archive.calculated_values cv ON (((s.nct_id)::text = (cv.nct_id)::text)))
     FULL JOIN ctgov_archive.designs d ON (((s.nct_id)::text = (d.nct_id)::text)))
     FULL JOIN ctgov_archive.eligibilities e ON (((s.nct_id)::text = (e.nct_id)::text)))
     FULL JOIN ctgov_archive.brief_summaries bs ON (((s.nct_id)::text = (bs.nct_id)::text)))
     FULL JOIN ctgov_archive.detailed_descriptions dd ON (((s.nct_id)::text = (dd.nct_id)::text)))
  WHERE (((sp.lead_or_collaborator)::text = 'lead'::text) AND ((s.nct_id)::text IN ( SELECT search_results.nct_id
           FROM ctgov_archive.search_results
          WHERE ((search_results.name)::text = 'covid-19'::text))));
...
--
-- Name: design_group_interventions; Type: TABLE; Schema: ctgov_archive; Owner: -
--

CREATE TABLE ctgov_archive.design_group_interventions (
    id integer NOT NULL,
    nct_id character varying,
    design_group_id integer,
    intervention_id integer
...
--
-- Name: design_group_interventions_id_seq; Type: SEQUENCE; Schema: ctgov_archive; Owner: -
--

CREATE SEQUENCE ctgov_archive.design_group_interventions_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: design_group_interventions_id_seq; Type: SEQUENCE OWNED BY; Schema: ctgov_archive; Owner: -
--

ALTER SEQUENCE ctgov_archive.design_group_interventions_id_seq OWNED BY ctgov_archive.design_group_interventions.id;


--
-- Name: design_groups_id_seq; Type: SEQUENCE; Schema: ctgov_archive; Owner: -
--

CREATE SEQUENCE ctgov_archive.design_groups_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: design_groups_id_seq; Type: SEQUENCE OWNED BY; Schema: ctgov_archive; Owner: -
--

ALTER SEQUENCE ctgov_archive.design_groups_id_seq OWNED BY ctgov_archive.design_groups.id;


--
-- Name: design_outcomes_id_seq; Type: SEQUENCE; Schema: ctgov_archive; Owner: -
--

CREATE SEQUENCE ctgov_archive.design_outcomes_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: design_outcomes_id_seq; Type: SEQUENCE OWNED BY; Schema: ctgov_archive; Owner: -
--

ALTER SEQUENCE ctgov_archive.design_outcomes_id_seq OWNED BY ctgov_archive.design_outcomes.id;


--
-- Name: designs_id_seq; Type: SEQUENCE; Schema: ctgov_archive; Owner: -
--

CREATE SEQUENCE ctgov_archive.designs_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: designs_id_seq; Type: SEQUENCE OWNED BY; Schema: ctgov_archive; Owner: -
--

ALTER SEQUENCE ctgov_archive.designs_id_seq OWNED BY ctgov_archive.designs.id;


--
-- Name: detailed_descriptions_id_seq; Type: SEQUENCE; Schema: ctgov_archive; Owner: -
--

CREATE SEQUENCE ctgov_archive.detailed_descriptions_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: detailed_descriptions_id_seq; Type: SEQUENCE OWNED BY; Schema: ctgov_archive; Owner: -
--

ALTER SEQUENCE ctgov_archive.detailed_descriptions_id_seq OWNED BY ctgov_archive.detailed_descriptions.id;


--
-- Name: documents; Type: TABLE; Schema: ctgov_archive; Owner: -
--

CREATE TABLE ctgov_archive.documents (
    id integer NOT NULL,
    nct_id character varying,
    document_id character varying,
    document_type character varying,
...
--
-- Name: documents_id_seq; Type: SEQUENCE; Schema: ctgov_archive; Owner: -
--

CREATE SEQUENCE ctgov_archive.documents_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: documents_id_seq; Type: SEQUENCE OWNED BY; Schema: ctgov_archive; Owner: -
--

ALTER SEQUENCE ctgov_archive.documents_id_seq OWNED BY ctgov_archive.documents.id;


--
-- Name: drop_withdrawals; Type: TABLE; Schema: ctgov_archive; Owner: -
--

CREATE TABLE ctgov_archive.drop_withdrawals (
    id integer NOT NULL,
    nct_id character varying,
    result_group_id integer,
    ctgov_group_code character varying,
...
--
-- Name: drop_withdrawals_id_seq; Type: SEQUENCE; Schema: ctgov_archive; Owner: -
--

CREATE SEQUENCE ctgov_archive.drop_withdrawals_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: drop_withdrawals_id_seq; Type: SEQUENCE OWNED BY; Schema: ctgov_archive; Owner: -
--

ALTER SEQUENCE ctgov_archive.drop_withdrawals_id_seq OWNED BY ctgov_archive.drop_withdrawals.id;


--
-- Name: eligibilities_id_seq; Type: SEQUENCE; Schema: ctgov_archive; Owner: -
--

CREATE SEQUENCE ctgov_archive.eligibilities_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: eligibilities_id_seq; Type: SEQUENCE OWNED BY; Schema: ctgov_archive; Owner: -
--

ALTER SEQUENCE ctgov_archive.eligibilities_id_seq OWNED BY ctgov_archive.eligibilities.id;


--
-- Name: facilities_id_seq; Type: SEQUENCE; Schema: ctgov_archive; Owner: -
--

CREATE SEQUENCE ctgov_archive.facilities_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: facilities_id_seq; Type: SEQUENCE OWNED BY; Schema: ctgov_archive; Owner: -
--

ALTER SEQUENCE ctgov_archive.facilities_id_seq OWNED BY ctgov_archive.facilities.id;


--
-- Name: facility_contacts; Type: TABLE; Schema: ctgov_archive; Owner: -
--

CREATE TABLE ctgov_archive.facility_contacts (
    id integer NOT NULL,
    nct_id character varying,
    facility_id integer,
    contact_type character varying,
...
--
-- Name: facility_contacts_id_seq; Type: SEQUENCE; Schema: ctgov_archive; Owner: -
--

CREATE SEQUENCE ctgov_archive.facility_contacts_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: facility_contacts_id_seq; Type: SEQUENCE OWNED BY; Schema: ctgov_archive; Owner: -
--

ALTER SEQUENCE ctgov_archive.facility_contacts_id_seq OWNED BY ctgov_archive.facility_contacts.id;


--
-- Name: facility_investigators; Type: TABLE; Schema: ctgov_archive; Owner: -
--

CREATE TABLE ctgov_archive.facility_investigators (
    id integer NOT NULL,
    nct_id character varying,
    facility_id integer,
    role character varying,
...
--
-- Name: facility_investigators_id_seq; Type: SEQUENCE; Schema: ctgov_archive; Owner: -
--

CREATE SEQUENCE ctgov_archive.facility_investigators_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: facility_investigators_id_seq; Type: SEQUENCE OWNED BY; Schema: ctgov_archive; Owner: -
--

ALTER SEQUENCE ctgov_archive.facility_investigators_id_seq OWNED BY ctgov_archive.facility_investigators.id;


--
-- Name: id_information_id_seq; Type: SEQUENCE; Schema: ctgov_archive; Owner: -
--

CREATE SEQUENCE ctgov_archive.id_information_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: id_information_id_seq; Type: SEQUENCE OWNED BY; Schema: ctgov_archive; Owner: -
--

ALTER SEQUENCE ctgov_archive.id_information_id_seq OWNED BY ctgov_archive.id_information.id;


--
-- Name: intervention_other_names; Type: TABLE; Schema: ctgov_archive; Owner: -
--

CREATE TABLE ctgov_archive.intervention_other_names (
    id integer NOT NULL,
    nct_id character varying,
    intervention_id integer,
    name character varying
...
--
-- Name: intervention_other_names_id_seq; Type: SEQUENCE; Schema: ctgov_archive; Owner: -
--

CREATE SEQUENCE ctgov_archive.intervention_other_names_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: intervention_other_names_id_seq; Type: SEQUENCE OWNED BY; Schema: ctgov_archive; Owner: -
--

ALTER SEQUENCE ctgov_archive.intervention_other_names_id_seq OWNED BY ctgov_archive.intervention_other_names.id;


--
-- Name: interventions_id_seq; Type: SEQUENCE; Schema: ctgov_archive; Owner: -
--

CREATE SEQUENCE ctgov_archive.interventions_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: interventions_id_seq; Type: SEQUENCE OWNED BY; Schema: ctgov_archive; Owner: -
--

ALTER SEQUENCE ctgov_archive.interventions_id_seq OWNED BY ctgov_archive.interventions.id;


--
-- Name: ipd_information_types; Type: TABLE; Schema: ctgov_archive; Owner: -
--

CREATE TABLE ctgov_archive.ipd_information_types (
    id integer NOT NULL,
    nct_id character varying,
    name character varying
);
...
--
-- Name: ipd_information_types_id_seq; Type: SEQUENCE; Schema: ctgov_archive; Owner: -
--

CREATE SEQUENCE ctgov_archive.ipd_information_types_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: ipd_information_types_id_seq; Type: SEQUENCE OWNED BY; Schema: ctgov_archive; Owner: -
--

ALTER SEQUENCE ctgov_archive.ipd_information_types_id_seq OWNED BY ctgov_archive.ipd_information_types.id;


--
-- Name: keywords_id_seq; Type: SEQUENCE; Schema: ctgov_archive; Owner: -
--

CREATE SEQUENCE ctgov_archive.keywords_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: keywords_id_seq; Type: SEQUENCE OWNED BY; Schema: ctgov_archive; Owner: -
--

ALTER SEQUENCE ctgov_archive.keywords_id_seq OWNED BY ctgov_archive.keywords.id;


--
-- Name: links; Type: TABLE; Schema: ctgov_archive; Owner: -
--

CREATE TABLE ctgov_archive.links (
    id integer NOT NULL,
    nct_id character varying,
    url character varying,
    description text
...
--
-- Name: links_id_seq; Type: SEQUENCE; Schema: ctgov_archive; Owner: -
--

CREATE SEQUENCE ctgov_archive.links_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: links_id_seq; Type: SEQUENCE OWNED BY; Schema: ctgov_archive; Owner: -
--

ALTER SEQUENCE ctgov_archive.links_id_seq OWNED BY ctgov_archive.links.id;


--
-- Name: mesh_headings; Type: TABLE; Schema: ctgov_archive; Owner: -
--

CREATE TABLE ctgov_archive.mesh_headings (
    id integer NOT NULL,
    qualifier character varying,
    heading character varying,
    subcategory character varying
...
--
-- Name: mesh_headings_id_seq; Type: SEQUENCE; Schema: ctgov_archive; Owner: -
--

CREATE SEQUENCE ctgov_archive.mesh_headings_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: mesh_headings_id_seq; Type: SEQUENCE OWNED BY; Schema: ctgov_archive; Owner: -
--

ALTER SEQUENCE ctgov_archive.mesh_headings_id_seq OWNED BY ctgov_archive.mesh_headings.id;


--
-- Name: mesh_terms; Type: TABLE; Schema: ctgov_archive; Owner: -
--

CREATE TABLE ctgov_archive.mesh_terms (
    id integer NOT NULL,
    qualifier character varying,
    tree_number character varying,
    description character varying,
...
--
-- Name: mesh_terms_id_seq; Type: SEQUENCE; Schema: ctgov_archive; Owner: -
--

CREATE SEQUENCE ctgov_archive.mesh_terms_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: mesh_terms_id_seq; Type: SEQUENCE OWNED BY; Schema: ctgov_archive; Owner: -
--

ALTER SEQUENCE ctgov_archive.mesh_terms_id_seq OWNED BY ctgov_archive.mesh_terms.id;


--
-- Name: milestones; Type: TABLE; Schema: ctgov_archive; Owner: -
--

CREATE TABLE ctgov_archive.milestones (
    id integer NOT NULL,
    nct_id character varying,
    result_group_id integer,
    ctgov_group_code character varying,
...
--
-- Name: milestones_id_seq; Type: SEQUENCE; Schema: ctgov_archive; Owner: -
--

CREATE SEQUENCE ctgov_archive.milestones_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: milestones_id_seq; Type: SEQUENCE OWNED BY; Schema: ctgov_archive; Owner: -
--

ALTER SEQUENCE ctgov_archive.milestones_id_seq OWNED BY ctgov_archive.milestones.id;


--
-- Name: outcome_analyses; Type: TABLE; Schema: ctgov_archive; Owner: -
--

CREATE TABLE ctgov_archive.outcome_analyses (
    id integer NOT NULL,
    nct_id character varying,
    outcome_id integer,
    non_inferiority_type character varying,
...
--
-- Name: outcome_analyses_id_seq; Type: SEQUENCE; Schema: ctgov_archive; Owner: -
--

CREATE SEQUENCE ctgov_archive.outcome_analyses_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: outcome_analyses_id_seq; Type: SEQUENCE OWNED BY; Schema: ctgov_archive; Owner: -
--

ALTER SEQUENCE ctgov_archive.outcome_analyses_id_seq OWNED BY ctgov_archive.outcome_analyses.id;


--
-- Name: outcome_analysis_groups; Type: TABLE; Schema: ctgov_archive; Owner: -
--

CREATE TABLE ctgov_archive.outcome_analysis_groups (
    id integer NOT NULL,
    nct_id character varying,
    outcome_analysis_id integer,
    result_group_id integer,
...
--
-- Name: outcome_analysis_groups_id_seq; Type: SEQUENCE; Schema: ctgov_archive; Owner: -
--

CREATE SEQUENCE ctgov_archive.outcome_analysis_groups_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: outcome_analysis_groups_id_seq; Type: SEQUENCE OWNED BY; Schema: ctgov_archive; Owner: -
--

ALTER SEQUENCE ctgov_archive.outcome_analysis_groups_id_seq OWNED BY ctgov_archive.outcome_analysis_groups.id;


--
-- Name: outcome_counts; Type: TABLE; Schema: ctgov_archive; Owner: -
--

CREATE TABLE ctgov_archive.outcome_counts (
    id integer NOT NULL,
    nct_id character varying,
    outcome_id integer,
    result_group_id integer,
...
--
-- Name: outcome_counts_id_seq; Type: SEQUENCE; Schema: ctgov_archive; Owner: -
--

CREATE SEQUENCE ctgov_archive.outcome_counts_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: outcome_counts_id_seq; Type: SEQUENCE OWNED BY; Schema: ctgov_archive; Owner: -
--

ALTER SEQUENCE ctgov_archive.outcome_counts_id_seq OWNED BY ctgov_archive.outcome_counts.id;


--
-- Name: outcome_measurements; Type: TABLE; Schema: ctgov_archive; Owner: -
--

CREATE TABLE ctgov_archive.outcome_measurements (
    id integer NOT NULL,
    nct_id character varying,
    outcome_id integer,
    result_group_id integer,
...
--
-- Name: outcome_measurements_id_seq; Type: SEQUENCE; Schema: ctgov_archive; Owner: -
--

CREATE SEQUENCE ctgov_archive.outcome_measurements_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: outcome_measurements_id_seq; Type: SEQUENCE OWNED BY; Schema: ctgov_archive; Owner: -
--

ALTER SEQUENCE ctgov_archive.outcome_measurements_id_seq OWNED BY ctgov_archive.outcome_measurements.id;


--
-- Name: outcomes; Type: TABLE; Schema: ctgov_archive; Owner: -
--

CREATE TABLE ctgov_archive.outcomes (
    id integer NOT NULL,
    nct_id character varying,
    outcome_type character varying,
    title text,
...
--
-- Name: outcomes_id_seq; Type: SEQUENCE; Schema: ctgov_archive; Owner: -
--

CREATE SEQUENCE ctgov_archive.outcomes_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: outcomes_id_seq; Type: SEQUENCE OWNED BY; Schema: ctgov_archive; Owner: -
--

ALTER SEQUENCE ctgov_archive.outcomes_id_seq OWNED BY ctgov_archive.outcomes.id;


--
-- Name: overall_officials_id_seq; Type: SEQUENCE; Schema: ctgov_archive; Owner: -
--

CREATE SEQUENCE ctgov_archive.overall_officials_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: overall_officials_id_seq; Type: SEQUENCE OWNED BY; Schema: ctgov_archive; Owner: -
--

ALTER SEQUENCE ctgov_archive.overall_officials_id_seq OWNED BY ctgov_archive.overall_officials.id;


--
-- Name: participant_flows; Type: TABLE; Schema: ctgov_archive; Owner: -
--

CREATE TABLE ctgov_archive.participant_flows (
    id integer NOT NULL,
    nct_id character varying,
    recruitment_details text,
    pre_assignment_details text
...
--
-- Name: participant_flows_id_seq; Type: SEQUENCE; Schema: ctgov_archive; Owner: -
--

CREATE SEQUENCE ctgov_archive.participant_flows_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: participant_flows_id_seq; Type: SEQUENCE OWNED BY; Schema: ctgov_archive; Owner: -
--

ALTER SEQUENCE ctgov_archive.participant_flows_id_seq OWNED BY ctgov_archive.participant_flows.id;


--
-- Name: pending_results; Type: TABLE; Schema: ctgov_archive; Owner: -
--

CREATE TABLE ctgov_archive.pending_results (
    id integer NOT NULL,
    nct_id character varying,
    event character varying,
    event_date_description character varying,
...
--
-- Name: pending_results_id_seq; Type: SEQUENCE; Schema: ctgov_archive; Owner: -
--

CREATE SEQUENCE ctgov_archive.pending_results_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: pending_results_id_seq; Type: SEQUENCE OWNED BY; Schema: ctgov_archive; Owner: -
--

ALTER SEQUENCE ctgov_archive.pending_results_id_seq OWNED BY ctgov_archive.pending_results.id;


--
-- Name: provided_documents; Type: TABLE; Schema: ctgov_archive; Owner: -
--

CREATE TABLE ctgov_archive.provided_documents (
    id integer NOT NULL,
    nct_id character varying,
    document_type character varying,
    has_protocol boolean,
...
--
-- Name: provided_documents_id_seq; Type: SEQUENCE; Schema: ctgov_archive; Owner: -
--

CREATE SEQUENCE ctgov_archive.provided_documents_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: provided_documents_id_seq; Type: SEQUENCE OWNED BY; Schema: ctgov_archive; Owner: -
--

ALTER SEQUENCE ctgov_archive.provided_documents_id_seq OWNED BY ctgov_archive.provided_documents.id;


--
-- Name: reported_event_totals; Type: TABLE; Schema: ctgov_archive; Owner: -
--

CREATE TABLE ctgov_archive.reported_event_totals (
    id integer NOT NULL,
    nct_id character varying NOT NULL,
    ctgov_group_code character varying NOT NULL,
    event_type character varying,
...
--
-- Name: reported_event_totals_id_seq; Type: SEQUENCE; Schema: ctgov_archive; Owner: -
--

CREATE SEQUENCE ctgov_archive.reported_event_totals_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: reported_event_totals_id_seq; Type: SEQUENCE OWNED BY; Schema: ctgov_archive; Owner: -
--

ALTER SEQUENCE ctgov_archive.reported_event_totals_id_seq OWNED BY ctgov_archive.reported_event_totals.id;


--
-- Name: reported_events; Type: TABLE; Schema: ctgov_archive; Owner: -
--

CREATE TABLE ctgov_archive.reported_events (
    id integer NOT NULL,
    nct_id character varying,
    result_group_id integer,
    ctgov_group_code character varying,
...
--
-- Name: reported_events_id_seq; Type: SEQUENCE; Schema: ctgov_archive; Owner: -
--

CREATE SEQUENCE ctgov_archive.reported_events_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: reported_events_id_seq; Type: SEQUENCE OWNED BY; Schema: ctgov_archive; Owner: -
--

ALTER SEQUENCE ctgov_archive.reported_events_id_seq OWNED BY ctgov_archive.reported_events.id;


--
-- Name: responsible_parties; Type: TABLE; Schema: ctgov_archive; Owner: -
--

CREATE TABLE ctgov_archive.responsible_parties (
    id integer NOT NULL,
    nct_id character varying,
    responsible_party_type character varying,
    name character varying,
...
--
-- Name: responsible_parties_id_seq; Type: SEQUENCE; Schema: ctgov_archive; Owner: -
--

CREATE SEQUENCE ctgov_archive.responsible_parties_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: responsible_parties_id_seq; Type: SEQUENCE OWNED BY; Schema: ctgov_archive; Owner: -
--

ALTER SEQUENCE ctgov_archive.responsible_parties_id_seq OWNED BY ctgov_archive.responsible_parties.id;


--
-- Name: result_agreements; Type: TABLE; Schema: ctgov_archive; Owner: -
--

CREATE TABLE ctgov_archive.result_agreements (
    id integer NOT NULL,
    nct_id character varying,
    pi_employee character varying,
    agreement text,
...
--
-- Name: result_agreements_id_seq; Type: SEQUENCE; Schema: ctgov_archive; Owner: -
--

CREATE SEQUENCE ctgov_archive.result_agreements_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: result_agreements_id_seq; Type: SEQUENCE OWNED BY; Schema: ctgov_archive; Owner: -
--

ALTER SEQUENCE ctgov_archive.result_agreements_id_seq OWNED BY ctgov_archive.result_agreements.id;


--
-- Name: result_contacts; Type: TABLE; Schema: ctgov_archive; Owner: -
--

CREATE TABLE ctgov_archive.result_contacts (
    id integer NOT NULL,
    nct_id character varying,
    organization character varying,
    name character varying,
...
--
-- Name: result_contacts_id_seq; Type: SEQUENCE; Schema: ctgov_archive; Owner: -
--

CREATE SEQUENCE ctgov_archive.result_contacts_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: result_contacts_id_seq; Type: SEQUENCE OWNED BY; Schema: ctgov_archive; Owner: -
--

ALTER SEQUENCE ctgov_archive.result_contacts_id_seq OWNED BY ctgov_archive.result_contacts.id;


--
-- Name: result_groups; Type: TABLE; Schema: ctgov_archive; Owner: -
--

CREATE TABLE ctgov_archive.result_groups (
    id integer NOT NULL,
    nct_id character varying,
    ctgov_group_code character varying,
    result_type character varying,
...
--
-- Name: result_groups_id_seq; Type: SEQUENCE; Schema: ctgov_archive; Owner: -
--

CREATE SEQUENCE ctgov_archive.result_groups_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: result_groups_id_seq; Type: SEQUENCE OWNED BY; Schema: ctgov_archive; Owner: -
--

ALTER SEQUENCE ctgov_archive.result_groups_id_seq OWNED BY ctgov_archive.result_groups.id;


--
-- Name: search_results_id_seq; Type: SEQUENCE; Schema: ctgov_archive; Owner: -
--

CREATE SEQUENCE ctgov_archive.search_results_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: search_results_id_seq; Type: SEQUENCE OWNED BY; Schema: ctgov_archive; Owner: -
--

ALTER SEQUENCE ctgov_archive.search_results_id_seq OWNED BY ctgov_archive.search_results.id;


--
-- Name: sponsors_id_seq; Type: SEQUENCE; Schema: ctgov_archive; Owner: -
--

CREATE SEQUENCE ctgov_archive.sponsors_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: sponsors_id_seq; Type: SEQUENCE OWNED BY; Schema: ctgov_archive; Owner: -
--

ALTER SEQUENCE ctgov_archive.sponsors_id_seq OWNED BY ctgov_archive.sponsors.id;


--
-- Name: study_references; Type: TABLE; Schema: ctgov_archive; Owner: -
--

CREATE TABLE ctgov_archive.study_references (
    id integer NOT NULL,
    nct_id character varying,
    pmid character varying,
    reference_type character varying,
...
--
-- Name: study_references_id_seq; Type: SEQUENCE; Schema: ctgov_archive; Owner: -
--

CREATE SEQUENCE ctgov_archive.study_references_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: study_references_id_seq; Type: SEQUENCE OWNED BY; Schema: ctgov_archive; Owner: -
--

ALTER SEQUENCE ctgov_archive.study_references_id_seq OWNED BY ctgov_archive.study_references.id;


--
-- Name: study_searches; Type: TABLE; Schema: ctgov_archive; Owner: -
--

CREATE TABLE ctgov_archive.study_searches (
    id integer NOT NULL,
    save_tsv boolean DEFAULT false NOT NULL,
    query character varying NOT NULL,
    "grouping" character varying DEFAULT ''::character varying NOT NULL,
...
--
-- Name: study_searches_id_seq; Type: SEQUENCE; Schema: ctgov_archive; Owner: -
--

CREATE SEQUENCE ctgov_archive.study_searches_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: study_searches_id_seq; Type: SEQUENCE OWNED BY; Schema: ctgov_archive; Owner: -
--

ALTER SEQUENCE ctgov_archive.study_searches_id_seq OWNED BY ctgov_archive.study_searches.id;
...
--
-- Name: baseline_counts id; Type: DEFAULT; Schema: ctgov_archive; Owner: -
--

ALTER TABLE ONLY ctgov_archive.baseline_counts ALTER COLUMN id SET DEFAULT nextval('ctgov_archive.baseline_counts_id_seq'::regclass);


--
-- Name: baseline_measurements id; Type: DEFAULT; Schema: ctgov_archive; Owner: -
--

ALTER TABLE ONLY ctgov_archive.baseline_measurements ALTER COLUMN id SET DEFAULT nextval('ctgov_archive.baseline_measurements_id_seq'::regclass);


--
-- Name: brief_summaries id; Type: DEFAULT; Schema: ctgov_archive; Owner: -
--

ALTER TABLE ONLY ctgov_archive.brief_summaries ALTER COLUMN id SET DEFAULT nextval('ctgov_archive.brief_summaries_id_seq'::regclass);


--
-- Name: browse_conditions id; Type: DEFAULT; Schema: ctgov_archive; Owner: -
--

ALTER TABLE ONLY ctgov_archive.browse_conditions ALTER COLUMN id SET DEFAULT nextval('ctgov_archive.browse_conditions_id_seq'::regclass);


--
-- Name: browse_interventions id; Type: DEFAULT; Schema: ctgov_archive; Owner: -
--

ALTER TABLE ONLY ctgov_archive.browse_interventions ALTER COLUMN id SET DEFAULT nextval('ctgov_archive.browse_interventions_id_seq'::regclass);


--
-- Name: calculated_values id; Type: DEFAULT; Schema: ctgov_archive; Owner: -
--

ALTER TABLE ONLY ctgov_archive.calculated_values ALTER COLUMN id SET DEFAULT nextval('ctgov_archive.calculated_values_id_seq'::regclass);


--
-- Name: central_contacts id; Type: DEFAULT; Schema: ctgov_archive; Owner: -
--

ALTER TABLE ONLY ctgov_archive.central_contacts ALTER COLUMN id SET DEFAULT nextval('ctgov_archive.central_contacts_id_seq'::regclass);


--
-- Name: conditions id; Type: DEFAULT; Schema: ctgov_archive; Owner: -
--

ALTER TABLE ONLY ctgov_archive.conditions ALTER COLUMN id SET DEFAULT nextval('ctgov_archive.conditions_id_seq'::regclass);


--
-- Name: countries id; Type: DEFAULT; Schema: ctgov_archive; Owner: -
--

ALTER TABLE ONLY ctgov_archive.countries ALTER COLUMN id SET DEFAULT nextval('ctgov_archive.countries_id_seq'::regclass);


--
-- Name: design_group_interventions id; Type: DEFAULT; Schema: ctgov_archive; Owner: -
--

ALTER TABLE ONLY ctgov_archive.design_group_interventions ALTER COLUMN id SET DEFAULT nextval('ctgov_archive.design_group_interventions_id_seq'::regclass);


--
-- Name: design_groups id; Type: DEFAULT; Schema: ctgov_archive; Owner: -
--

ALTER TABLE ONLY ctgov_archive.design_groups ALTER COLUMN id SET DEFAULT nextval('ctgov_archive.design_groups_id_seq'::regclass);


--
-- Name: design_outcomes id; Type: DEFAULT; Schema: ctgov_archive; Owner: -
--

ALTER TABLE ONLY ctgov_archive.design_outcomes ALTER COLUMN id SET DEFAULT nextval('ctgov_archive.design_outcomes_id_seq'::regclass);


--
-- Name: designs id; Type: DEFAULT; Schema: ctgov_archive; Owner: -
--

ALTER TABLE ONLY ctgov_archive.designs ALTER COLUMN id SET DEFAULT nextval('ctgov_archive.designs_id_seq'::regclass);


--
-- Name: detailed_descriptions id; Type: DEFAULT; Schema: ctgov_archive; Owner: -
--

ALTER TABLE ONLY ctgov_archive.detailed_descriptions ALTER COLUMN id SET DEFAULT nextval('ctgov_archive.detailed_descriptions_id_seq'::regclass);


--
-- Name: documents id; Type: DEFAULT; Schema: ctgov_archive; Owner: -
--

ALTER TABLE ONLY ctgov_archive.documents ALTER COLUMN id SET DEFAULT nextval('ctgov_archive.documents_id_seq'::regclass);


--
-- Name: drop_withdrawals id; Type: DEFAULT; Schema: ctgov_archive; Owner: -
--

ALTER TABLE ONLY ctgov_archive.drop_withdrawals ALTER COLUMN id SET DEFAULT nextval('ctgov_archive.drop_withdrawals_id_seq'::regclass);


--
-- Name: eligibilities id; Type: DEFAULT; Schema: ctgov_archive; Owner: -
--

ALTER TABLE ONLY ctgov_archive.eligibilities ALTER COLUMN id SET DEFAULT nextval('ctgov_archive.eligibilities_id_seq'::regclass);


--
-- Name: facilities id; Type: DEFAULT; Schema: ctgov_archive; Owner: -
--

ALTER TABLE ONLY ctgov_archive.facilities ALTER COLUMN id SET DEFAULT nextval('ctgov_archive.facilities_id_seq'::regclass);


--
-- Name: facility_contacts id; Type: DEFAULT; Schema: ctgov_archive; Owner: -
--

ALTER TABLE ONLY ctgov_archive.facility_contacts ALTER COLUMN id SET DEFAULT nextval('ctgov_archive.facility_contacts_id_seq'::regclass);


--
-- Name: facility_investigators id; Type: DEFAULT; Schema: ctgov_archive; Owner: -
--

ALTER TABLE ONLY ctgov_archive.facility_investigators ALTER COLUMN id SET DEFAULT nextval('ctgov_archive.facility_investigators_id_seq'::regclass);


--
-- Name: id_information id; Type: DEFAULT; Schema: ctgov_archive; Owner: -
--

ALTER TABLE ONLY ctgov_archive.id_information ALTER COLUMN id SET DEFAULT nextval('ctgov_archive.id_information_id_seq'::regclass);


--
-- Name: intervention_other_names id; Type: DEFAULT; Schema: ctgov_archive; Owner: -
--

ALTER TABLE ONLY ctgov_archive.intervention_other_names ALTER COLUMN id SET DEFAULT nextval('ctgov_archive.intervention_other_names_id_seq'::regclass);


--
-- Name: interventions id; Type: DEFAULT; Schema: ctgov_archive; Owner: -
--

ALTER TABLE ONLY ctgov_archive.interventions ALTER COLUMN id SET DEFAULT nextval('ctgov_archive.interventions_id_seq'::regclass);


--
-- Name: ipd_information_types id; Type: DEFAULT; Schema: ctgov_archive; Owner: -
--

ALTER TABLE ONLY ctgov_archive.ipd_information_types ALTER COLUMN id SET DEFAULT nextval('ctgov_archive.ipd_information_types_id_seq'::regclass);


--
-- Name: keywords id; Type: DEFAULT; Schema: ctgov_archive; Owner: -
--

ALTER TABLE ONLY ctgov_archive.keywords ALTER COLUMN id SET DEFAULT nextval('ctgov_archive.keywords_id_seq'::regclass);


--
-- Name: links id; Type: DEFAULT; Schema: ctgov_archive; Owner: -
--

ALTER TABLE ONLY ctgov_archive.links ALTER COLUMN id SET DEFAULT nextval('ctgov_archive.links_id_seq'::regclass);


--
-- Name: mesh_headings id; Type: DEFAULT; Schema: ctgov_archive; Owner: -
--

ALTER TABLE ONLY ctgov_archive.mesh_headings ALTER COLUMN id SET DEFAULT nextval('ctgov_archive.mesh_headings_id_seq'::regclass);


--
-- Name: mesh_terms id; Type: DEFAULT; Schema: ctgov_archive; Owner: -
--

ALTER TABLE ONLY ctgov_archive.mesh_terms ALTER COLUMN id SET DEFAULT nextval('ctgov_archive.mesh_terms_id_seq'::regclass);


--
-- Name: milestones id; Type: DEFAULT; Schema: ctgov_archive; Owner: -
--

ALTER TABLE ONLY ctgov_archive.milestones ALTER COLUMN id SET DEFAULT nextval('ctgov_archive.milestones_id_seq'::regclass);


--
-- Name: outcome_analyses id; Type: DEFAULT; Schema: ctgov_archive; Owner: -
--

ALTER TABLE ONLY ctgov_archive.outcome_analyses ALTER COLUMN id SET DEFAULT nextval('ctgov_archive.outcome_analyses_id_seq'::regclass);


--
-- Name: outcome_analysis_groups id; Type: DEFAULT; Schema: ctgov_archive; Owner: -
--

ALTER TABLE ONLY ctgov_archive.outcome_analysis_groups ALTER COLUMN id SET DEFAULT nextval('ctgov_archive.outcome_analysis_groups_id_seq'::regclass);


--
-- Name: outcome_counts id; Type: DEFAULT; Schema: ctgov_archive; Owner: -
--

ALTER TABLE ONLY ctgov_archive.outcome_counts ALTER COLUMN id SET DEFAULT nextval('ctgov_archive.outcome_counts_id_seq'::regclass);


--
-- Name: outcome_measurements id; Type: DEFAULT; Schema: ctgov_archive; Owner: -
--

ALTER TABLE ONLY ctgov_archive.outcome_measurements ALTER COLUMN id SET DEFAULT nextval('ctgov_archive.outcome_measurements_id_seq'::regclass);


--
-- Name: outcomes id; Type: DEFAULT; Schema: ctgov_archive; Owner: -
--

ALTER TABLE ONLY ctgov_archive.outcomes ALTER COLUMN id SET DEFAULT nextval('ctgov_archive.outcomes_id_seq'::regclass);


--
-- Name: overall_officials id; Type: DEFAULT; Schema: ctgov_archive; Owner: -
--

ALTER TABLE ONLY ctgov_archive.overall_officials ALTER COLUMN id SET DEFAULT nextval('ctgov_archive.overall_officials_id_seq'::regclass);


--
-- Name: participant_flows id; Type: DEFAULT; Schema: ctgov_archive; Owner: -
--

ALTER TABLE ONLY ctgov_archive.participant_flows ALTER COLUMN id SET DEFAULT nextval('ctgov_archive.participant_flows_id_seq'::regclass);


--
-- Name: pending_results id; Type: DEFAULT; Schema: ctgov_archive; Owner: -
--

ALTER TABLE ONLY ctgov_archive.pending_results ALTER COLUMN id SET DEFAULT nextval('ctgov_archive.pending_results_id_seq'::regclass);


--
-- Name: provided_documents id; Type: DEFAULT; Schema: ctgov_archive; Owner: -
--

ALTER TABLE ONLY ctgov_archive.provided_documents ALTER COLUMN id SET DEFAULT nextval('ctgov_archive.provided_documents_id_seq'::regclass);


--
-- Name: reported_event_totals id; Type: DEFAULT; Schema: ctgov_archive; Owner: -
--

ALTER TABLE ONLY ctgov_archive.reported_event_totals ALTER COLUMN id SET DEFAULT nextval('ctgov_archive.reported_event_totals_id_seq'::regclass);


--
-- Name: reported_events id; Type: DEFAULT; Schema: ctgov_archive; Owner: -
--

ALTER TABLE ONLY ctgov_archive.reported_events ALTER COLUMN id SET DEFAULT nextval('ctgov_archive.reported_events_id_seq'::regclass);


--
-- Name: responsible_parties id; Type: DEFAULT; Schema: ctgov_archive; Owner: -
--

ALTER TABLE ONLY ctgov_archive.responsible_parties ALTER COLUMN id SET DEFAULT nextval('ctgov_archive.responsible_parties_id_seq'::regclass);


--
-- Name: result_agreements id; Type: DEFAULT; Schema: ctgov_archive; Owner: -
--

ALTER TABLE ONLY ctgov_archive.result_agreements ALTER COLUMN id SET DEFAULT nextval('ctgov_archive.result_agreements_id_seq'::regclass);


--
-- Name: result_contacts id; Type: DEFAULT; Schema: ctgov_archive; Owner: -
--

ALTER TABLE ONLY ctgov_archive.result_contacts ALTER COLUMN id SET DEFAULT nextval('ctgov_archive.result_contacts_id_seq'::regclass);


--
-- Name: result_groups id; Type: DEFAULT; Schema: ctgov_archive; Owner: -
--

ALTER TABLE ONLY ctgov_archive.result_groups ALTER COLUMN id SET DEFAULT nextval('ctgov_archive.result_groups_id_seq'::regclass);


--
-- Name: search_results id; Type: DEFAULT; Schema: ctgov_archive; Owner: -
--

ALTER TABLE ONLY ctgov_archive.search_results ALTER COLUMN id SET DEFAULT nextval('ctgov_archive.search_results_id_seq'::regclass);


--
-- Name: sponsors id; Type: DEFAULT; Schema: ctgov_archive; Owner: -
--

ALTER TABLE ONLY ctgov_archive.sponsors ALTER COLUMN id SET DEFAULT nextval('ctgov_archive.sponsors_id_seq'::regclass);


--
-- Name: study_references id; Type: DEFAULT; Schema: ctgov_archive; Owner: -
--

ALTER TABLE ONLY ctgov_archive.study_references ALTER COLUMN id SET DEFAULT nextval('ctgov_archive.study_references_id_seq'::regclass);


--
-- Name: study_searches id; Type: DEFAULT; Schema: ctgov_archive; Owner: -
--

ALTER TABLE ONLY ctgov_archive.study_searches ALTER COLUMN id SET DEFAULT nextval('ctgov_archive.study_searches_id_seq'::regclass);
...
--
-- Name: ar_internal_metadata ar_internal_metadata_pkey; Type: CONSTRAINT; Schema: ctgov_archive; Owner: -
--

ALTER TABLE ONLY ctgov_archive.ar_internal_metadata
    ADD CONSTRAINT ar_internal_metadata_pkey PRIMARY KEY (key);


--
-- Name: baseline_counts baseline_counts_pkey; Type: CONSTRAINT; Schema: ctgov_archive; Owner: -
--

ALTER TABLE ONLY ctgov_archive.baseline_counts
    ADD CONSTRAINT baseline_counts_pkey PRIMARY KEY (id);


--
-- Name: baseline_measurements baseline_measurements_pkey; Type: CONSTRAINT; Schema: ctgov_archive; Owner: -
--

ALTER TABLE ONLY ctgov_archive.baseline_measurements
    ADD CONSTRAINT baseline_measurements_pkey PRIMARY KEY (id);


--
-- Name: brief_summaries brief_summaries_pkey; Type: CONSTRAINT; Schema: ctgov_archive; Owner: -
--

ALTER TABLE ONLY ctgov_archive.brief_summaries
    ADD CONSTRAINT brief_summaries_pkey PRIMARY KEY (id);


--
-- Name: browse_conditions browse_conditions_pkey; Type: CONSTRAINT; Schema: ctgov_archive; Owner: -
--

ALTER TABLE ONLY ctgov_archive.browse_conditions
    ADD CONSTRAINT browse_conditions_pkey PRIMARY KEY (id);


--
-- Name: browse_interventions browse_interventions_pkey; Type: CONSTRAINT; Schema: ctgov_archive; Owner: -
--

ALTER TABLE ONLY ctgov_archive.browse_interventions
    ADD CONSTRAINT browse_interventions_pkey PRIMARY KEY (id);


--
-- Name: calculated_values calculated_values_pkey; Type: CONSTRAINT; Schema: ctgov_archive; Owner: -
--

ALTER TABLE ONLY ctgov_archive.calculated_values
    ADD CONSTRAINT calculated_values_pkey PRIMARY KEY (id);


--
-- Name: central_contacts central_contacts_pkey; Type: CONSTRAINT; Schema: ctgov_archive; Owner: -
--

ALTER TABLE ONLY ctgov_archive.central_contacts
    ADD CONSTRAINT central_contacts_pkey PRIMARY KEY (id);


--
-- Name: conditions conditions_pkey; Type: CONSTRAINT; Schema: ctgov_archive; Owner: -
--

ALTER TABLE ONLY ctgov_archive.conditions
    ADD CONSTRAINT conditions_pkey PRIMARY KEY (id);


--
-- Name: countries countries_pkey; Type: CONSTRAINT; Schema: ctgov_archive; Owner: -
--

ALTER TABLE ONLY ctgov_archive.countries
    ADD CONSTRAINT countries_pkey PRIMARY KEY (id);


--
-- Name: design_group_interventions design_group_interventions_pkey; Type: CONSTRAINT; Schema: ctgov_archive; Owner: -
--

ALTER TABLE ONLY ctgov_archive.design_group_interventions
    ADD CONSTRAINT design_group_interventions_pkey PRIMARY KEY (id);


--
-- Name: design_groups design_groups_pkey; Type: CONSTRAINT; Schema: ctgov_archive; Owner: -
--

ALTER TABLE ONLY ctgov_archive.design_groups
    ADD CONSTRAINT design_groups_pkey PRIMARY KEY (id);


--
-- Name: design_outcomes design_outcomes_pkey; Type: CONSTRAINT; Schema: ctgov_archive; Owner: -
--

ALTER TABLE ONLY ctgov_archive.design_outcomes
    ADD CONSTRAINT design_outcomes_pkey PRIMARY KEY (id);


--
-- Name: designs designs_pkey; Type: CONSTRAINT; Schema: ctgov_archive; Owner: -
--

ALTER TABLE ONLY ctgov_archive.designs
    ADD CONSTRAINT designs_pkey PRIMARY KEY (id);


--
-- Name: detailed_descriptions detailed_descriptions_pkey; Type: CONSTRAINT; Schema: ctgov_archive; Owner: -
--

ALTER TABLE ONLY ctgov_archive.detailed_descriptions
    ADD CONSTRAINT detailed_descriptions_pkey PRIMARY KEY (id);


--
-- Name: documents documents_pkey; Type: CONSTRAINT; Schema: ctgov_archive; Owner: -
--

ALTER TABLE ONLY ctgov_archive.documents
    ADD CONSTRAINT documents_pkey PRIMARY KEY (id);


--
-- Name: drop_withdrawals drop_withdrawals_pkey; Type: CONSTRAINT; Schema: ctgov_archive; Owner: -
--

ALTER TABLE ONLY ctgov_archive.drop_withdrawals
    ADD CONSTRAINT drop_withdrawals_pkey PRIMARY KEY (id);


--
-- Name: eligibilities eligibilities_pkey; Type: CONSTRAINT; Schema: ctgov_archive; Owner: -
--

ALTER TABLE ONLY ctgov_archive.eligibilities
    ADD CONSTRAINT eligibilities_pkey PRIMARY KEY (id);


--
-- Name: facilities facilities_pkey; Type: CONSTRAINT; Schema: ctgov_archive; Owner: -
--

ALTER TABLE ONLY ctgov_archive.facilities
    ADD CONSTRAINT facilities_pkey PRIMARY KEY (id);


--
-- Name: facility_contacts facility_contacts_pkey; Type: CONSTRAINT; Schema: ctgov_archive; Owner: -
--

ALTER TABLE ONLY ctgov_archive.facility_contacts
    ADD CONSTRAINT facility_contacts_pkey PRIMARY KEY (id);


--
-- Name: facility_investigators facility_investigators_pkey; Type: CONSTRAINT; Schema: ctgov_archive; Owner: -
--

ALTER TABLE ONLY ctgov_archive.facility_investigators
    ADD CONSTRAINT facility_investigators_pkey PRIMARY KEY (id);


--
-- Name: id_information id_information_pkey; Type: CONSTRAINT; Schema: ctgov_archive; Owner: -
--

ALTER TABLE ONLY ctgov_archive.id_information
    ADD CONSTRAINT id_information_pkey PRIMARY KEY (id);


--
-- Name: intervention_other_names intervention_other_names_pkey; Type: CONSTRAINT; Schema: ctgov_archive; Owner: -
--

ALTER TABLE ONLY ctgov_archive.intervention_other_names
    ADD CONSTRAINT intervention_other_names_pkey PRIMARY KEY (id);


--
-- Name: interventions interventions_pkey; Type: CONSTRAINT; Schema: ctgov_archive; Owner: -
--

ALTER TABLE ONLY ctgov_archive.interventions
    ADD CONSTRAINT interventions_pkey PRIMARY KEY (id);


--
-- Name: ipd_information_types ipd_information_types_pkey; Type: CONSTRAINT; Schema: ctgov_archive; Owner: -
--

ALTER TABLE ONLY ctgov_archive.ipd_information_types
    ADD CONSTRAINT ipd_information_types_pkey PRIMARY KEY (id);


--
-- Name: keywords keywords_pkey; Type: CONSTRAINT; Schema: ctgov_archive; Owner: -
--

ALTER TABLE ONLY ctgov_archive.keywords
    ADD CONSTRAINT keywords_pkey PRIMARY KEY (id);


--
-- Name: links links_pkey; Type: CONSTRAINT; Schema: ctgov_archive; Owner: -
--

ALTER TABLE ONLY ctgov_archive.links
    ADD CONSTRAINT links_pkey PRIMARY KEY (id);


--
-- Name: mesh_headings mesh_headings_pkey; Type: CONSTRAINT; Schema: ctgov_archive; Owner: -
--

ALTER TABLE ONLY ctgov_archive.mesh_headings
    ADD CONSTRAINT mesh_headings_pkey PRIMARY KEY (id);


--
-- Name: mesh_terms mesh_terms_pkey; Type: CONSTRAINT; Schema: ctgov_archive; Owner: -
--

ALTER TABLE ONLY ctgov_archive.mesh_terms
    ADD CONSTRAINT mesh_terms_pkey PRIMARY KEY (id);


--
-- Name: milestones milestones_pkey; Type: CONSTRAINT; Schema: ctgov_archive; Owner: -
--

ALTER TABLE ONLY ctgov_archive.milestones
    ADD CONSTRAINT milestones_pkey PRIMARY KEY (id);


--
-- Name: outcome_analyses outcome_analyses_pkey; Type: CONSTRAINT; Schema: ctgov_archive; Owner: -
--

ALTER TABLE ONLY ctgov_archive.outcome_analyses
    ADD CONSTRAINT outcome_analyses_pkey PRIMARY KEY (id);


--
-- Name: outcome_analysis_groups outcome_analysis_groups_pkey; Type: CONSTRAINT; Schema: ctgov_archive; Owner: -
--

ALTER TABLE ONLY ctgov_archive.outcome_analysis_groups
    ADD CONSTRAINT outcome_analysis_groups_pkey PRIMARY KEY (id);


--
-- Name: outcome_counts outcome_counts_pkey; Type: CONSTRAINT; Schema: ctgov_archive; Owner: -
--

ALTER TABLE ONLY ctgov_archive.outcome_counts
    ADD CONSTRAINT outcome_counts_pkey PRIMARY KEY (id);


--
-- Name: outcome_measurements outcome_measurements_pkey; Type: CONSTRAINT; Schema: ctgov_archive; Owner: -
--

ALTER TABLE ONLY ctgov_archive.outcome_measurements
    ADD CONSTRAINT outcome_measurements_pkey PRIMARY KEY (id);


--
-- Name: outcomes outcomes_pkey; Type: CONSTRAINT; Schema: ctgov_archive; Owner: -
--

ALTER TABLE ONLY ctgov_archive.outcomes
    ADD CONSTRAINT outcomes_pkey PRIMARY KEY (id);


--
-- Name: overall_officials overall_officials_pkey; Type: CONSTRAINT; Schema: ctgov_archive; Owner: -
--

ALTER TABLE ONLY ctgov_archive.overall_officials
    ADD CONSTRAINT overall_officials_pkey PRIMARY KEY (id);


--
-- Name: participant_flows participant_flows_pkey; Type: CONSTRAINT; Schema: ctgov_archive; Owner: -
--

ALTER TABLE ONLY ctgov_archive.participant_flows
    ADD CONSTRAINT participant_flows_pkey PRIMARY KEY (id);


--
-- Name: pending_results pending_results_pkey; Type: CONSTRAINT; Schema: ctgov_archive; Owner: -
--

ALTER TABLE ONLY ctgov_archive.pending_results
    ADD CONSTRAINT pending_results_pkey PRIMARY KEY (id);


--
-- Name: provided_documents provided_documents_pkey; Type: CONSTRAINT; Schema: ctgov_archive; Owner: -
--

ALTER TABLE ONLY ctgov_archive.provided_documents
    ADD CONSTRAINT provided_documents_pkey PRIMARY KEY (id);


--
-- Name: reported_event_totals reported_event_totals_pkey; Type: CONSTRAINT; Schema: ctgov_archive; Owner: -
--

ALTER TABLE ONLY ctgov_archive.reported_event_totals
    ADD CONSTRAINT reported_event_totals_pkey PRIMARY KEY (id);


--
-- Name: reported_events reported_events_pkey; Type: CONSTRAINT; Schema: ctgov_archive; Owner: -
--

ALTER TABLE ONLY ctgov_archive.reported_events
    ADD CONSTRAINT reported_events_pkey PRIMARY KEY (id);


--
-- Name: responsible_parties responsible_parties_pkey; Type: CONSTRAINT; Schema: ctgov_archive; Owner: -
--

ALTER TABLE ONLY ctgov_archive.responsible_parties
    ADD CONSTRAINT responsible_parties_pkey PRIMARY KEY (id);


--
-- Name: result_agreements result_agreements_pkey; Type: CONSTRAINT; Schema: ctgov_archive; Owner: -
--

ALTER TABLE ONLY ctgov_archive.result_agreements
    ADD CONSTRAINT result_agreements_pkey PRIMARY KEY (id);


--
-- Name: result_contacts result_contacts_pkey; Type: CONSTRAINT; Schema: ctgov_archive; Owner: -
--

ALTER TABLE ONLY ctgov_archive.result_contacts
    ADD CONSTRAINT result_contacts_pkey PRIMARY KEY (id);


--
-- Name: result_groups result_groups_pkey; Type: CONSTRAINT; Schema: ctgov_archive; Owner: -
--

ALTER TABLE ONLY ctgov_archive.result_groups
    ADD CONSTRAINT result_groups_pkey PRIMARY KEY (id);


--
-- Name: search_results search_results_pkey; Type: CONSTRAINT; Schema: ctgov_archive; Owner: -
--

ALTER TABLE ONLY ctgov_archive.search_results
    ADD CONSTRAINT search_results_pkey PRIMARY KEY (id);


--
-- Name: sponsors sponsors_pkey; Type: CONSTRAINT; Schema: ctgov_archive; Owner: -
--

ALTER TABLE ONLY ctgov_archive.sponsors
    ADD CONSTRAINT sponsors_pkey PRIMARY KEY (id);


--
-- Name: study_references study_references_pkey; Type: CONSTRAINT; Schema: ctgov_archive; Owner: -
--

ALTER TABLE ONLY ctgov_archive.study_references
    ADD CONSTRAINT study_references_pkey PRIMARY KEY (id);


--
-- Name: study_searches study_searches_pkey; Type: CONSTRAINT; Schema: ctgov_archive; Owner: -
--

ALTER TABLE ONLY ctgov_archive.study_searches
    ADD CONSTRAINT study_searches_pkey PRIMARY KEY (id);
...
--
-- Name: index_retractions_on_nct_id; Type: INDEX; Schema: ctgov; Owner: -
--

CREATE INDEX index_retractions_on_nct_id ON ctgov.retractions USING btree (nct_id);
...
--
-- Name: baseline_counts_nct_idx; Type: INDEX; Schema: ctgov_archive; Owner: -
--

CREATE INDEX baseline_counts_nct_idx ON ctgov_archive.baseline_counts USING btree (nct_id);


--
-- Name: baseline_measurements_nct_idx; Type: INDEX; Schema: ctgov_archive; Owner: -
--

CREATE INDEX baseline_measurements_nct_idx ON ctgov_archive.baseline_measurements USING btree (nct_id);


--
-- Name: brief_summaries_nct_idx; Type: INDEX; Schema: ctgov_archive; Owner: -
--

CREATE INDEX brief_summaries_nct_idx ON ctgov_archive.brief_summaries USING btree (nct_id);


--
-- Name: browse_conditions_nct_idx; Type: INDEX; Schema: ctgov_archive; Owner: -
--

CREATE INDEX browse_conditions_nct_idx ON ctgov_archive.browse_conditions USING btree (nct_id);


--
-- Name: browse_interventions_nct_idx; Type: INDEX; Schema: ctgov_archive; Owner: -
--

CREATE INDEX browse_interventions_nct_idx ON ctgov_archive.browse_interventions USING btree (nct_id);


--
-- Name: calculated_values_nct_idx; Type: INDEX; Schema: ctgov_archive; Owner: -
--

CREATE INDEX calculated_values_nct_idx ON ctgov_archive.calculated_values USING btree (nct_id);


--
-- Name: categories_nct_idx; Type: INDEX; Schema: ctgov_archive; Owner: -
--

CREATE INDEX categories_nct_idx ON ctgov_archive.search_results USING btree (nct_id);


--
-- Name: central_contacts_nct_idx; Type: INDEX; Schema: ctgov_archive; Owner: -
--

CREATE INDEX central_contacts_nct_idx ON ctgov_archive.central_contacts USING btree (nct_id);


--
-- Name: conditions_nct_idx; Type: INDEX; Schema: ctgov_archive; Owner: -
--

CREATE INDEX conditions_nct_idx ON ctgov_archive.conditions USING btree (nct_id);


--
-- Name: countries_nct_idx; Type: INDEX; Schema: ctgov_archive; Owner: -
--

CREATE INDEX countries_nct_idx ON ctgov_archive.countries USING btree (nct_id);


--
-- Name: design_group_interventions_nct_idx; Type: INDEX; Schema: ctgov_archive; Owner: -
--

CREATE INDEX design_group_interventions_nct_idx ON ctgov_archive.design_group_interventions USING btree (nct_id);


--
-- Name: design_groups_nct_idx; Type: INDEX; Schema: ctgov_archive; Owner: -
--

CREATE INDEX design_groups_nct_idx ON ctgov_archive.design_groups USING btree (nct_id);


--
-- Name: design_outcomes_nct_idx; Type: INDEX; Schema: ctgov_archive; Owner: -
--

CREATE INDEX design_outcomes_nct_idx ON ctgov_archive.design_outcomes USING btree (nct_id);


--
-- Name: designs_nct_idx; Type: INDEX; Schema: ctgov_archive; Owner: -
--

CREATE INDEX designs_nct_idx ON ctgov_archive.designs USING btree (nct_id);


--
-- Name: detailed_descriptions_nct_idx; Type: INDEX; Schema: ctgov_archive; Owner: -
--

CREATE INDEX detailed_descriptions_nct_idx ON ctgov_archive.detailed_descriptions USING btree (nct_id);


--
-- Name: documents_nct_idx; Type: INDEX; Schema: ctgov_archive; Owner: -
--

CREATE INDEX documents_nct_idx ON ctgov_archive.documents USING btree (nct_id);


--
-- Name: drop_withdrawals_nct_idx; Type: INDEX; Schema: ctgov_archive; Owner: -
--

CREATE INDEX drop_withdrawals_nct_idx ON ctgov_archive.drop_withdrawals USING btree (nct_id);


--
-- Name: eligibilities_nct_idx; Type: INDEX; Schema: ctgov_archive; Owner: -
--

CREATE INDEX eligibilities_nct_idx ON ctgov_archive.eligibilities USING btree (nct_id);


--
-- Name: facilities_nct_idx; Type: INDEX; Schema: ctgov_archive; Owner: -
--

CREATE INDEX facilities_nct_idx ON ctgov_archive.facilities USING btree (nct_id);


--
-- Name: facility_contacts_nct_idx; Type: INDEX; Schema: ctgov_archive; Owner: -
--

CREATE INDEX facility_contacts_nct_idx ON ctgov_archive.facility_contacts USING btree (nct_id);


--
-- Name: facility_investigators_nct_idx; Type: INDEX; Schema: ctgov_archive; Owner: -
--

CREATE INDEX facility_investigators_nct_idx ON ctgov_archive.facility_investigators USING btree (nct_id);


--
-- Name: id_information_nct_idx; Type: INDEX; Schema: ctgov_archive; Owner: -
--

CREATE INDEX id_information_nct_idx ON ctgov_archive.id_information USING btree (nct_id);


--
-- Name: index_baseline_counts_on_nct_id; Type: INDEX; Schema: ctgov_archive; Owner: -
--

CREATE INDEX index_baseline_counts_on_nct_id ON ctgov_archive.baseline_counts USING btree (nct_id);


--
-- Name: index_baseline_measurements_on_nct_id; Type: INDEX; Schema: ctgov_archive; Owner: -
--

CREATE INDEX index_baseline_measurements_on_nct_id ON ctgov_archive.baseline_measurements USING btree (nct_id);


--
-- Name: index_brief_summaries_on_nct_id; Type: INDEX; Schema: ctgov_archive; Owner: -
--

CREATE UNIQUE INDEX index_brief_summaries_on_nct_id ON ctgov_archive.brief_summaries USING btree (nct_id);


--
-- Name: index_browse_conditions_on_nct_id; Type: INDEX; Schema: ctgov_archive; Owner: -
--

CREATE INDEX index_browse_conditions_on_nct_id ON ctgov_archive.browse_conditions USING btree (nct_id);


--
-- Name: index_browse_interventions_on_nct_id; Type: INDEX; Schema: ctgov_archive; Owner: -
--

CREATE INDEX index_browse_interventions_on_nct_id ON ctgov_archive.browse_interventions USING btree (nct_id);


--
-- Name: index_calculated_values_on_nct_id; Type: INDEX; Schema: ctgov_archive; Owner: -
--

CREATE UNIQUE INDEX index_calculated_values_on_nct_id ON ctgov_archive.calculated_values USING btree (nct_id);


--
-- Name: index_central_contacts_on_nct_id; Type: INDEX; Schema: ctgov_archive; Owner: -
--

CREATE INDEX index_central_contacts_on_nct_id ON ctgov_archive.central_contacts USING btree (nct_id);


--
-- Name: index_conditions_on_nct_id; Type: INDEX; Schema: ctgov_archive; Owner: -
--

CREATE INDEX index_conditions_on_nct_id ON ctgov_archive.conditions USING btree (nct_id);


--
-- Name: index_countries_on_nct_id; Type: INDEX; Schema: ctgov_archive; Owner: -
--

CREATE INDEX index_countries_on_nct_id ON ctgov_archive.countries USING btree (nct_id);


--
-- Name: index_design_group_interventions_on_nct_id; Type: INDEX; Schema: ctgov_archive; Owner: -
--

CREATE INDEX index_design_group_interventions_on_nct_id ON ctgov_archive.design_group_interventions USING btree (nct_id);


--
-- Name: index_design_groups_on_nct_id; Type: INDEX; Schema: ctgov_archive; Owner: -
--

CREATE INDEX index_design_groups_on_nct_id ON ctgov_archive.design_groups USING btree (nct_id);


--
-- Name: index_design_outcomes_on_nct_id; Type: INDEX; Schema: ctgov_archive; Owner: -
--

CREATE INDEX index_design_outcomes_on_nct_id ON ctgov_archive.design_outcomes USING btree (nct_id);


--
-- Name: index_designs_on_nct_id; Type: INDEX; Schema: ctgov_archive; Owner: -
--

CREATE UNIQUE INDEX index_designs_on_nct_id ON ctgov_archive.designs USING btree (nct_id);


--
-- Name: index_detailed_descriptions_on_nct_id; Type: INDEX; Schema: ctgov_archive; Owner: -
--

CREATE UNIQUE INDEX index_detailed_descriptions_on_nct_id ON ctgov_archive.detailed_descriptions USING btree (nct_id);


--
-- Name: index_documents_on_nct_id; Type: INDEX; Schema: ctgov_archive; Owner: -
--

CREATE INDEX index_documents_on_nct_id ON ctgov_archive.documents USING btree (nct_id);


--
-- Name: index_drop_withdrawals_on_nct_id; Type: INDEX; Schema: ctgov_archive; Owner: -
--

CREATE INDEX index_drop_withdrawals_on_nct_id ON ctgov_archive.drop_withdrawals USING btree (nct_id);


--
-- Name: index_eligibilities_on_nct_id; Type: INDEX; Schema: ctgov_archive; Owner: -
--

CREATE UNIQUE INDEX index_eligibilities_on_nct_id ON ctgov_archive.eligibilities USING btree (nct_id);


--
-- Name: index_facilities_on_nct_id; Type: INDEX; Schema: ctgov_archive; Owner: -
--

CREATE INDEX index_facilities_on_nct_id ON ctgov_archive.facilities USING btree (nct_id);


--
-- Name: index_facility_contacts_on_nct_id; Type: INDEX; Schema: ctgov_archive; Owner: -
--

CREATE INDEX index_facility_contacts_on_nct_id ON ctgov_archive.facility_contacts USING btree (nct_id);


--
-- Name: index_facility_investigators_on_nct_id; Type: INDEX; Schema: ctgov_archive; Owner: -
--

CREATE INDEX index_facility_investigators_on_nct_id ON ctgov_archive.facility_investigators USING btree (nct_id);


--
-- Name: index_id_information_on_nct_id; Type: INDEX; Schema: ctgov_archive; Owner: -
--

CREATE INDEX index_id_information_on_nct_id ON ctgov_archive.id_information USING btree (nct_id);


--
-- Name: index_intervention_other_names_on_nct_id; Type: INDEX; Schema: ctgov_archive; Owner: -
--

CREATE INDEX index_intervention_other_names_on_nct_id ON ctgov_archive.intervention_other_names USING btree (nct_id);


--
-- Name: index_interventions_on_nct_id; Type: INDEX; Schema: ctgov_archive; Owner: -
--

CREATE INDEX index_interventions_on_nct_id ON ctgov_archive.interventions USING btree (nct_id);


--
-- Name: index_ipd_information_types_on_nct_id; Type: INDEX; Schema: ctgov_archive; Owner: -
--

CREATE INDEX index_ipd_information_types_on_nct_id ON ctgov_archive.ipd_information_types USING btree (nct_id);


--
-- Name: index_keywords_on_nct_id; Type: INDEX; Schema: ctgov_archive; Owner: -
--

CREATE INDEX index_keywords_on_nct_id ON ctgov_archive.keywords USING btree (nct_id);


--
-- Name: index_links_on_nct_id; Type: INDEX; Schema: ctgov_archive; Owner: -
--

CREATE INDEX index_links_on_nct_id ON ctgov_archive.links USING btree (nct_id);


--
-- Name: index_mesh_headings_on_qualifier; Type: INDEX; Schema: ctgov_archive; Owner: -
--

CREATE INDEX index_mesh_headings_on_qualifier ON ctgov_archive.mesh_headings USING btree (qualifier);


--
-- Name: index_mesh_terms_on_description; Type: INDEX; Schema: ctgov_archive; Owner: -
--

CREATE INDEX index_mesh_terms_on_description ON ctgov_archive.mesh_terms USING btree (description);


--
-- Name: index_mesh_terms_on_downcase_mesh_term; Type: INDEX; Schema: ctgov_archive; Owner: -
--

CREATE INDEX index_mesh_terms_on_downcase_mesh_term ON ctgov_archive.mesh_terms USING btree (downcase_mesh_term);


--
-- Name: index_mesh_terms_on_mesh_term; Type: INDEX; Schema: ctgov_archive; Owner: -
--

CREATE INDEX index_mesh_terms_on_mesh_term ON ctgov_archive.mesh_terms USING btree (mesh_term);


--
-- Name: index_mesh_terms_on_qualifier; Type: INDEX; Schema: ctgov_archive; Owner: -
--

CREATE INDEX index_mesh_terms_on_qualifier ON ctgov_archive.mesh_terms USING btree (qualifier);


--
-- Name: index_milestones_on_nct_id; Type: INDEX; Schema: ctgov_archive; Owner: -
--

CREATE INDEX index_milestones_on_nct_id ON ctgov_archive.milestones USING btree (nct_id);


--
-- Name: index_outcome_analyses_on_nct_id; Type: INDEX; Schema: ctgov_archive; Owner: -
--

CREATE INDEX index_outcome_analyses_on_nct_id ON ctgov_archive.outcome_analyses USING btree (nct_id);


--
-- Name: index_outcome_analysis_groups_on_nct_id; Type: INDEX; Schema: ctgov_archive; Owner: -
--

CREATE INDEX index_outcome_analysis_groups_on_nct_id ON ctgov_archive.outcome_analysis_groups USING btree (nct_id);


--
-- Name: index_outcome_counts_on_nct_id; Type: INDEX; Schema: ctgov_archive; Owner: -
--

CREATE INDEX index_outcome_counts_on_nct_id ON ctgov_archive.outcome_counts USING btree (nct_id);


--
-- Name: index_outcome_measurements_on_nct_id; Type: INDEX; Schema: ctgov_archive; Owner: -
--

CREATE INDEX index_outcome_measurements_on_nct_id ON ctgov_archive.outcome_measurements USING btree (nct_id);


--
-- Name: index_outcomes_on_nct_id; Type: INDEX; Schema: ctgov_archive; Owner: -
--

CREATE INDEX index_outcomes_on_nct_id ON ctgov_archive.outcomes USING btree (nct_id);


--
-- Name: index_overall_officials_on_nct_id; Type: INDEX; Schema: ctgov_archive; Owner: -
--

CREATE INDEX index_overall_officials_on_nct_id ON ctgov_archive.overall_officials USING btree (nct_id);


--
-- Name: index_participant_flows_on_nct_id; Type: INDEX; Schema: ctgov_archive; Owner: -
--

CREATE UNIQUE INDEX index_participant_flows_on_nct_id ON ctgov_archive.participant_flows USING btree (nct_id);


--
-- Name: index_pending_results_on_nct_id; Type: INDEX; Schema: ctgov_archive; Owner: -
--

CREATE INDEX index_pending_results_on_nct_id ON ctgov_archive.pending_results USING btree (nct_id);


--
-- Name: index_provided_documents_on_nct_id; Type: INDEX; Schema: ctgov_archive; Owner: -
--

CREATE INDEX index_provided_documents_on_nct_id ON ctgov_archive.provided_documents USING btree (nct_id);


--
-- Name: index_reported_event_totals_on_nct_id; Type: INDEX; Schema: ctgov_archive; Owner: -
--

CREATE INDEX index_reported_event_totals_on_nct_id ON ctgov_archive.reported_event_totals USING btree (nct_id);


--
-- Name: index_reported_events_on_nct_id; Type: INDEX; Schema: ctgov_archive; Owner: -
--

CREATE INDEX index_reported_events_on_nct_id ON ctgov_archive.reported_events USING btree (nct_id);


--
-- Name: index_responsible_parties_on_nct_id; Type: INDEX; Schema: ctgov_archive; Owner: -
--

CREATE INDEX index_responsible_parties_on_nct_id ON ctgov_archive.responsible_parties USING btree (nct_id);


--
-- Name: index_result_agreements_on_nct_id; Type: INDEX; Schema: ctgov_archive; Owner: -
--

CREATE INDEX index_result_agreements_on_nct_id ON ctgov_archive.result_agreements USING btree (nct_id);


--
-- Name: index_result_contacts_on_nct_id; Type: INDEX; Schema: ctgov_archive; Owner: -
--

CREATE INDEX index_result_contacts_on_nct_id ON ctgov_archive.result_contacts USING btree (nct_id);


--
-- Name: index_result_groups_on_nct_id; Type: INDEX; Schema: ctgov_archive; Owner: -
--

CREATE INDEX index_result_groups_on_nct_id ON ctgov_archive.result_groups USING btree (nct_id);


--
-- Name: index_search_results_on_nct_id; Type: INDEX; Schema: ctgov_archive; Owner: -
--

CREATE INDEX index_search_results_on_nct_id ON ctgov_archive.search_results USING btree (nct_id);


--
-- Name: index_sponsors_on_nct_id; Type: INDEX; Schema: ctgov_archive; Owner: -
--

CREATE INDEX index_sponsors_on_nct_id ON ctgov_archive.sponsors USING btree (nct_id);


--
-- Name: index_studies_on_nct_id; Type: INDEX; Schema: ctgov_archive; Owner: -
--

CREATE UNIQUE INDEX index_studies_on_nct_id ON ctgov_archive.studies USING btree (nct_id);


--
-- Name: index_study_references_on_nct_id; Type: INDEX; Schema: ctgov_archive; Owner: -
--

CREATE INDEX index_study_references_on_nct_id ON ctgov_archive.study_references USING btree (nct_id);


--
-- Name: intervention_other_names_nct_idx; Type: INDEX; Schema: ctgov_archive; Owner: -
--

CREATE INDEX intervention_other_names_nct_idx ON ctgov_archive.intervention_other_names USING btree (nct_id);


--
-- Name: interventions_nct_idx; Type: INDEX; Schema: ctgov_archive; Owner: -
--

CREATE INDEX interventions_nct_idx ON ctgov_archive.interventions USING btree (nct_id);


--
-- Name: ipd_information_types_nct_idx; Type: INDEX; Schema: ctgov_archive; Owner: -
--

CREATE INDEX ipd_information_types_nct_idx ON ctgov_archive.ipd_information_types USING btree (nct_id);


--
-- Name: keywords_nct_idx; Type: INDEX; Schema: ctgov_archive; Owner: -
--

CREATE INDEX keywords_nct_idx ON ctgov_archive.keywords USING btree (nct_id);


--
-- Name: links_nct_idx; Type: INDEX; Schema: ctgov_archive; Owner: -
--

CREATE INDEX links_nct_idx ON ctgov_archive.links USING btree (nct_id);


--
-- Name: milestones_nct_idx; Type: INDEX; Schema: ctgov_archive; Owner: -
--

CREATE INDEX milestones_nct_idx ON ctgov_archive.milestones USING btree (nct_id);


--
-- Name: outcome_analyses_nct_idx; Type: INDEX; Schema: ctgov_archive; Owner: -
--

CREATE INDEX outcome_analyses_nct_idx ON ctgov_archive.outcome_analyses USING btree (nct_id);


--
-- Name: outcome_analysis_groups_nct_idx; Type: INDEX; Schema: ctgov_archive; Owner: -
--

CREATE INDEX outcome_analysis_groups_nct_idx ON ctgov_archive.outcome_analysis_groups USING btree (nct_id);


--
-- Name: outcome_counts_nct_idx; Type: INDEX; Schema: ctgov_archive; Owner: -
--

CREATE INDEX outcome_counts_nct_idx ON ctgov_archive.outcome_counts USING btree (nct_id);


--
-- Name: outcome_measurements_nct_idx; Type: INDEX; Schema: ctgov_archive; Owner: -
--

CREATE INDEX outcome_measurements_nct_idx ON ctgov_archive.outcome_measurements USING btree (nct_id);


--
-- Name: outcomes_nct_idx; Type: INDEX; Schema: ctgov_archive; Owner: -
--

CREATE INDEX outcomes_nct_idx ON ctgov_archive.outcomes USING btree (nct_id);


--
-- Name: overall_officials_nct_idx; Type: INDEX; Schema: ctgov_archive; Owner: -
--

CREATE INDEX overall_officials_nct_idx ON ctgov_archive.overall_officials USING btree (nct_id);


--
-- Name: participant_flows_nct_idx; Type: INDEX; Schema: ctgov_archive; Owner: -
--

CREATE INDEX participant_flows_nct_idx ON ctgov_archive.participant_flows USING btree (nct_id);


--
-- Name: pending_results_nct_idx; Type: INDEX; Schema: ctgov_archive; Owner: -
--

CREATE INDEX pending_results_nct_idx ON ctgov_archive.pending_results USING btree (nct_id);


--
-- Name: provided_documents_nct_idx; Type: INDEX; Schema: ctgov_archive; Owner: -
--

CREATE INDEX provided_documents_nct_idx ON ctgov_archive.provided_documents USING btree (nct_id);


--
-- Name: reported_event_totals_nct_idx; Type: INDEX; Schema: ctgov_archive; Owner: -
--

CREATE INDEX reported_event_totals_nct_idx ON ctgov_archive.reported_event_totals USING btree (nct_id);


--
-- Name: reported_events_nct_idx; Type: INDEX; Schema: ctgov_archive; Owner: -
--

CREATE INDEX reported_events_nct_idx ON ctgov_archive.reported_events USING btree (nct_id);


--
-- Name: responsible_parties_nct_idx; Type: INDEX; Schema: ctgov_archive; Owner: -
--

CREATE INDEX responsible_parties_nct_idx ON ctgov_archive.responsible_parties USING btree (nct_id);


--
-- Name: result_agreements_nct_idx; Type: INDEX; Schema: ctgov_archive; Owner: -
--

CREATE INDEX result_agreements_nct_idx ON ctgov_archive.result_agreements USING btree (nct_id);


--
-- Name: result_contacts_nct_idx; Type: INDEX; Schema: ctgov_archive; Owner: -
--

CREATE INDEX result_contacts_nct_idx ON ctgov_archive.result_contacts USING btree (nct_id);


--
-- Name: result_groups_nct_idx; Type: INDEX; Schema: ctgov_archive; Owner: -
--

CREATE INDEX result_groups_nct_idx ON ctgov_archive.result_groups USING btree (nct_id);


--
-- Name: sponsors_nct_idx; Type: INDEX; Schema: ctgov_archive; Owner: -
--

CREATE INDEX sponsors_nct_idx ON ctgov_archive.sponsors USING btree (nct_id);


--
-- Name: studies_nct_idx; Type: INDEX; Schema: ctgov_archive; Owner: -
--

CREATE INDEX studies_nct_idx ON ctgov_archive.studies USING btree (nct_id);


--
-- Name: study_references_nct_idx; Type: INDEX; Schema: ctgov_archive; Owner: -
--

CREATE INDEX study_references_nct_idx ON ctgov_archive.study_references USING btree (nct_id);
...
--
-- Name: categories category_insert_trigger; Type: TRIGGER; Schema: ctgov_archive; Owner: -
--

CREATE TRIGGER category_insert_trigger INSTEAD OF INSERT ON ctgov_archive.categories FOR EACH ROW EXECUTE PROCEDURE ctgov_archive.category_insert_function();
...
--
-- Name: baseline_counts baseline_counts_result_group_id_fkey; Type: FK CONSTRAINT; Schema: ctgov_archive; Owner: -
--

ALTER TABLE ONLY ctgov_archive.baseline_counts
    ADD CONSTRAINT baseline_counts_result_group_id_fkey FOREIGN KEY (result_group_id) REFERENCES ctgov_archive.result_groups(id);


--
-- Name: baseline_measurements baseline_measurements_result_group_id_fkey; Type: FK CONSTRAINT; Schema: ctgov_archive; Owner: -
--

ALTER TABLE ONLY ctgov_archive.baseline_measurements
    ADD CONSTRAINT baseline_measurements_result_group_id_fkey FOREIGN KEY (result_group_id) REFERENCES ctgov_archive.result_groups(id);


--
-- Name: design_group_interventions design_group_interventions_design_group_id_fkey; Type: FK CONSTRAINT; Schema: ctgov_archive; Owner: -
--

ALTER TABLE ONLY ctgov_archive.design_group_interventions
    ADD CONSTRAINT design_group_interventions_design_group_id_fkey FOREIGN KEY (design_group_id) REFERENCES ctgov_archive.design_groups(id);


--
-- Name: design_group_interventions design_group_interventions_intervention_id_fkey; Type: FK CONSTRAINT; Schema: ctgov_archive; Owner: -
--

ALTER TABLE ONLY ctgov_archive.design_group_interventions
    ADD CONSTRAINT design_group_interventions_intervention_id_fkey FOREIGN KEY (intervention_id) REFERENCES ctgov_archive.interventions(id);


--
-- Name: drop_withdrawals drop_withdrawals_result_group_id_fkey; Type: FK CONSTRAINT; Schema: ctgov_archive; Owner: -
--

ALTER TABLE ONLY ctgov_archive.drop_withdrawals
    ADD CONSTRAINT drop_withdrawals_result_group_id_fkey FOREIGN KEY (result_group_id) REFERENCES ctgov_archive.result_groups(id);


--
-- Name: facility_contacts facility_contacts_facility_id_fkey; Type: FK CONSTRAINT; Schema: ctgov_archive; Owner: -
--

ALTER TABLE ONLY ctgov_archive.facility_contacts
    ADD CONSTRAINT facility_contacts_facility_id_fkey FOREIGN KEY (facility_id) REFERENCES ctgov_archive.facilities(id);


--
-- Name: facility_investigators facility_investigators_facility_id_fkey; Type: FK CONSTRAINT; Schema: ctgov_archive; Owner: -
--

ALTER TABLE ONLY ctgov_archive.facility_investigators
    ADD CONSTRAINT facility_investigators_facility_id_fkey FOREIGN KEY (facility_id) REFERENCES ctgov_archive.facilities(id);


--
-- Name: intervention_other_names intervention_other_names_intervention_id_fkey; Type: FK CONSTRAINT; Schema: ctgov_archive; Owner: -
--

ALTER TABLE ONLY ctgov_archive.intervention_other_names
    ADD CONSTRAINT intervention_other_names_intervention_id_fkey FOREIGN KEY (intervention_id) REFERENCES ctgov_archive.interventions(id);


--
-- Name: milestones milestones_result_group_id_fkey; Type: FK CONSTRAINT; Schema: ctgov_archive; Owner: -
--

ALTER TABLE ONLY ctgov_archive.milestones
    ADD CONSTRAINT milestones_result_group_id_fkey FOREIGN KEY (result_group_id) REFERENCES ctgov_archive.result_groups(id);


--
-- Name: outcome_analyses outcome_analyses_outcome_id_fkey; Type: FK CONSTRAINT; Schema: ctgov_archive; Owner: -
--

ALTER TABLE ONLY ctgov_archive.outcome_analyses
    ADD CONSTRAINT outcome_analyses_outcome_id_fkey FOREIGN KEY (outcome_id) REFERENCES ctgov_archive.outcomes(id);


--
-- Name: outcome_analysis_groups outcome_analysis_groups_outcome_analysis_id_fkey; Type: FK CONSTRAINT; Schema: ctgov_archive; Owner: -
--

ALTER TABLE ONLY ctgov_archive.outcome_analysis_groups
    ADD CONSTRAINT outcome_analysis_groups_outcome_analysis_id_fkey FOREIGN KEY (outcome_analysis_id) REFERENCES ctgov_archive.outcome_analyses(id);


--
-- Name: outcome_analysis_groups outcome_analysis_groups_result_group_id_fkey; Type: FK CONSTRAINT; Schema: ctgov_archive; Owner: -
--

ALTER TABLE ONLY ctgov_archive.outcome_analysis_groups
    ADD CONSTRAINT outcome_analysis_groups_result_group_id_fkey FOREIGN KEY (result_group_id) REFERENCES ctgov_archive.result_groups(id);


--
-- Name: outcome_counts outcome_counts_outcome_id_fkey; Type: FK CONSTRAINT; Schema: ctgov_archive; Owner: -
--

ALTER TABLE ONLY ctgov_archive.outcome_counts
    ADD CONSTRAINT outcome_counts_outcome_id_fkey FOREIGN KEY (outcome_id) REFERENCES ctgov_archive.outcomes(id);


--
-- Name: outcome_counts outcome_counts_result_group_id_fkey; Type: FK CONSTRAINT; Schema: ctgov_archive; Owner: -
--

ALTER TABLE ONLY ctgov_archive.outcome_counts
    ADD CONSTRAINT outcome_counts_result_group_id_fkey FOREIGN KEY (result_group_id) REFERENCES ctgov_archive.result_groups(id);


--
-- Name: outcome_measurements outcome_measurements_outcome_id_fkey; Type: FK CONSTRAINT; Schema: ctgov_archive; Owner: -
--

ALTER TABLE ONLY ctgov_archive.outcome_measurements
    ADD CONSTRAINT outcome_measurements_outcome_id_fkey FOREIGN KEY (outcome_id) REFERENCES ctgov_archive.outcomes(id);


--
-- Name: outcome_measurements outcome_measurements_result_group_id_fkey; Type: FK CONSTRAINT; Schema: ctgov_archive; Owner: -
--

ALTER TABLE ONLY ctgov_archive.outcome_measurements
    ADD CONSTRAINT outcome_measurements_result_group_id_fkey FOREIGN KEY (result_group_id) REFERENCES ctgov_archive.result_groups(id);


--
-- Name: reported_events reported_events_result_group_id_fkey; Type: FK CONSTRAINT; Schema: ctgov_archive; Owner: -
--

ALTER TABLE ONLY ctgov_archive.reported_events
    ADD CONSTRAINT reported_events_result_group_id_fkey FOREIGN KEY (result_group_id) REFERENCES ctgov_archive.result_groups(id);
