...
--
-- Name: historical; Type: SCHEMA; Schema: -; Owner: -
--
...
--
-- Name: study_enrollment_types; Type: TABLE; Schema: historical; Owner: -
--

CREATE TABLE historical.study_enrollment_types (
    id integer NOT NULL,
    name character varying,
    created_at timestamp without time zone NOT NULL,
    updated_at timestamp without time zone NOT NULL
...
--
-- Name: study_enrollment_types_id_seq; Type: SEQUENCE; Schema: historical; Owner: -
--

CREATE SEQUENCE historical.study_enrollment_types_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
--
-- Name: study_enrollment_types_id_seq; Type: SEQUENCE OWNED BY; Schema: historical; Owner: -
--

ALTER SEQUENCE historical.study_enrollment_types_id_seq OWNED BY historical.study_enrollment_types.id;


--
-- Name: study_histories; Type: TABLE; Schema: historical; Owner: -
--

CREATE TABLE historical.study_histories (
    id integer NOT NULL,
    nct_id character varying,
    study_enrollment_type_id integer,
...
--
-- Name: study_histories_id_seq; Type: SEQUENCE; Schema: historical; Owner: -
--

CREATE SEQUENCE historical.study_histories_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
--
-- Name: study_histories_id_seq; Type: SEQUENCE OWNED BY; Schema: historical; Owner: -
--

ALTER SEQUENCE historical.study_histories_id_seq OWNED BY historical.study_histories.id;
...
--
-- Name: study_enrollment_types id; Type: DEFAULT; Schema: historical; Owner: -
--

ALTER TABLE ONLY historical.study_enrollment_types ALTER COLUMN id SET DEFAULT nextval('historical.study_enrollment_types_id_seq'::regclass);


--
-- Name: study_histories id; Type: DEFAULT; Schema: historical; Owner: -
--

ALTER TABLE ONLY historical.study_histories ALTER COLUMN id SET DEFAULT nextval('historical.study_histories_id_seq'::regclass);
...
--
-- Name: study_enrollment_types study_enrollment_types_pkey; Type: CONSTRAINT; Schema: historical; Owner: -
--

ALTER TABLE ONLY historical.study_enrollment_types
    ADD CONSTRAINT study_enrollment_types_pkey PRIMARY KEY (id);


--
-- Name: study_histories study_histories_pkey; Type: CONSTRAINT; Schema: historical; Owner: -
--

ALTER TABLE ONLY historical.study_histories
    ADD CONSTRAINT study_histories_pkey PRIMARY KEY (id);
...
INSERT INTO schema_migrations (version) VALUES ('20200123155527');

INSERT INTO schema_migrations (version) VALUES ('20200123155734');
