class ChangeStudyDates < ActiveRecord::Migration
  def change
    remove_column :studies, :start_date_str
    remove_column :studies, :first_received_date_str
    remove_column :studies, :verification_date_str
    remove_column :studies, :last_changed_date_str
    remove_column :studies, :primary_completion_date_str
    remove_column :studies, :completion_date_str
    remove_column :studies, :first_received_results_date_str
    remove_column :studies, :download_date_str

    add_column :studies, :start_date_month_day, :string
    add_column :studies, :first_received_date_month_day, :string
    add_column :studies, :verification_date_month_day, :string
    add_column :studies, :last_changed_date_month_day, :string
    ...
    add_column :calculated_values, :last_changed_date, :date
