...
--
      ...
      RETURNS table (nct_id varchar, title text, recruitment varchar,
                   ...
                   other_ids text, first_received_date date, start_date date, completion_month_year varchar,
                   last_changed_date date, verification_month_year varchar,
                   first_received_results_date date, acronym varchar, primary_completion_month_year varchar,
                   outcome_measures text, received_results_disposit_date date,
