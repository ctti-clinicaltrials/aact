shared_examples 'a serialized study' do
  ...
  it 'should have expected keys and values' do
    ...
    expect(serialized_study['start_date_str']).to eq(resource.start_date_str)
    expect(serialized_study['first_received_date_str']).to eq(resource.first_received_date_str)
    expect(serialized_study['verification_date_str']).to eq(resource.verification_date_str)
    expect(serialized_study['last_changed_date_str']).to eq(resource.last_changed_date_str)
    expect(serialized_study['primary_completion_date_str']).to eq(resource.primary_completion_date_str)
    expect(serialized_study['completion_date_str']).to eq(resource.completion_date_str)
    expect(serialized_study['first_received_results_date_str']).to eq(resource.first_received_results_date_str)
    expect(serialized_study['download_date_str']).to eq(resource.download_date_str)
