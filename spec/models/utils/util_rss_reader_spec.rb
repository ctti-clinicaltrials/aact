  ...
  describe '#initialize' do
    ...
    context 'without a specified days_back arg' do
      it 'should generate the correct url' do
        changed_url = "https://clinicaltrials.gov/ct2/results/rss.xml?lup_d=1&count=10000"
        added_url   = "https://clinicaltrials.gov/ct2/results/rss.xml?rcv_d=1&count=10000"
    ...
    context 'with a specified days_back arg' do
      it 'should generate the correct url' do
        changed_url = "https://clinicaltrials.gov/ct2/results/rss.xml?lup_d=14&count=10000"
        added_url   = "https://clinicaltrials.gov/ct2/results/rss.xml?rcv_d=14&count=10000"
