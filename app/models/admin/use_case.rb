module Admin
  class UseCase < Admin::AdminBase
    ...
    def initialize(params = {})
      ...
      super
      self.attachments << Admin::UseCaseAttachment.create_from(file) if file and attachment.nil?
      self.attachments << Admin::UseCaseAttachment.create_from(image_file,'image') if image_file and image.nil?
      self
    end
    ...
    def update(params = {})
      ...
      self.attachments << Admin::UseCaseAttachment.create_from(file) if file
      self.attachments << Admin::UseCaseAttachment.create_from(image_file,'image') if image_file
      super
      self
    end
