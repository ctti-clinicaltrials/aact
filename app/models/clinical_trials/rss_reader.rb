...
module ClinicalTrials
  class RssReader
    ...
    def initialize(days_back: 1)
      @changed_url = "#{BASE_URL}/ct2/results/rss.xml?rcv_d=&lup_d=#{days_back}&sel_rss=mod#{days_back}&recrs=a&count=10000"
      @added_url   = "#{BASE_URL}/ct2/results/rss.xml?rcv_d=#{days_back}&lup_d=&sel_rss=new#{days_back}&recrs=a&count=10000"
    end
