module Node
  class StatusModule < Node::Base
    ...
    attr_accessor :study_first_post_date_struct, :results_first_post_date_struct, :disp_first_post_date_struct, :last_update_post_date_struct, :start_date_struct, :completion_date_struct, :primary_completion_date_struct
