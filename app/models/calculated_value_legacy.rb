...
class CalculatedValueLegacy < ActiveRecord::Base
  ...
  # def self.sql_for_were_results_reported
  #   "SET were_results_reported = true WHERE EXISTS (SELECT 1 FROM outcomes WHERE outcomes.nct_id = calculated_values.nct_id)"
  # end
