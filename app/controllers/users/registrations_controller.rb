class Users::RegistrationsController < Devise::RegistrationsController
  ...
  def create
    ...
    if resource.errors.size == 0
      UserEventMailer.report_user_event('created', resource)
  ...
  def destroy
    ...
    if resource.errors.empty?
      UserEventMailer.report_user_event('removed', resource)
  ...
  def update_resource(resource, params)
    ...
    if resource.errors.size == 0
      UserEventMailer.report_user_event('updated', resource)
    end
  end
